...
def test_TestYumUpdateCheckParse__assert_expected():
    ret = TestYumUpdateCheckParse()._assert_expected()

def test_TestYumUpdateCheckParse_test_empty_output():
    ret = TestYumUpdateCheckParse().test_empty_output()

def test_TestYumUpdateCheckParse_test_longname():
    ret = TestYumUpdateCheckParse().test_longname()

def test_TestYumUpdateCheckParse_test_plugin_load_error():
    ret = TestYumUpdateCheckParse().test_plugin_load_error()

def test_TestYumUpdateCheckParse_test_wrapped_output_1():
    ret = TestYumUpdateCheckParse().test_wrapped_output_1()

def test_TestYumUpdateCheckParse_test_wrapped_output_2():
    ret = TestYumUpdateCheckParse().test_wrapped_output_2()

def test_TestYumUpdateCheckParse_test_wrapped_output_3():
    ret = TestYumUpdateCheckParse().test_wrapped_output_3()

def test_TestYumUpdateCheckParse_test_wrapped_output_4():
    ret = TestYumUpdateCheckParse().test_wrapped_output_4()

def test_TestYumUpdateCheckParse_test_wrapped_output_rhel7():
    ret = TestYumUpdateCheckParse().test_wrapped_output_rhel7()

def test_TestYumUpdateCheckParse_test_wrapped_output_rhel7_obsoletes():
    ret = TestYumUpdateCheckParse().test_wrapped_output_rhel7_obsoletes()