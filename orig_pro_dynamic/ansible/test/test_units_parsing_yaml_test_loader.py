...
class TestAnsibleLoaderVault(unittest.TestCase, YamlTestUtils):
    ...
    def test_embedded_vault_from_dump(self):
        ...
        blip = {'stuff1': [{'a dict key': 24}, {'shhh-ssh-secrets': avu, 'nothing to see here': 'move along'}], 'another key': 24.1}
...
class TestAnsibleLoaderPlay(unittest.TestCase):
    ...
    def test_data_complete(self):
        ...
        self.assertEqual(self.data[0][u'vars'][u'dictionary'], {u'webster': u'daniel', u'oed': u'oxford'})
...
def test_TestAnsibleLoaderBasic_test_parse_number():
    ret = TestAnsibleLoaderBasic().test_parse_number()

def test_TestAnsibleLoaderBasic_test_parse_string():
    ret = TestAnsibleLoaderBasic().test_parse_string()

def test_TestAnsibleLoaderBasic_test_parse_utf8_string():
    ret = TestAnsibleLoaderBasic().test_parse_utf8_string()

def test_TestAnsibleLoaderBasic_test_parse_dict():
    ret = TestAnsibleLoaderBasic().test_parse_dict()

def test_TestAnsibleLoaderBasic_test_parse_list():
    ret = TestAnsibleLoaderBasic().test_parse_list()

def test_TestAnsibleLoaderBasic_test_parse_short_dict():
    ret = TestAnsibleLoaderBasic().test_parse_short_dict()

def test_TestAnsibleLoaderBasic_test_error_conditions():
    ret = TestAnsibleLoaderBasic().test_error_conditions()

def test_TestAnsibleLoaderBasic_test_tab_error():
    ret = TestAnsibleLoaderBasic().test_tab_error()

def test_TestAnsibleLoaderBasic_test_front_matter():
    ret = TestAnsibleLoaderBasic().test_front_matter()

def test_TestAnsibleLoaderVault_setUp():
    ret = TestAnsibleLoaderVault().setUp()

def test_TestAnsibleLoaderVault_vault_secret():
    ret = TestAnsibleLoaderVault().vault_secret()

def test_TestAnsibleLoaderVault_test_wrong_password():
    ret = TestAnsibleLoaderVault().test_wrong_password()

def test_TestAnsibleLoaderVault__encrypt_plaintext():
    ret = TestAnsibleLoaderVault()._encrypt_plaintext()

def test_TestAnsibleLoaderVault__build_stream():
    ret = TestAnsibleLoaderVault()._build_stream()

def test_TestAnsibleLoaderVault__loader():
    ret = TestAnsibleLoaderVault()._loader()

def test_TestAnsibleLoaderVault__load_yaml():
    ret = TestAnsibleLoaderVault()._load_yaml()

def test_TestAnsibleLoaderVault_test_dump_load_cycle():
    ret = TestAnsibleLoaderVault().test_dump_load_cycle()

def test_TestAnsibleLoaderVault_test_embedded_vault_from_dump():
    ret = TestAnsibleLoaderVault().test_embedded_vault_from_dump()

def test_TestAnsibleLoaderVault_test_embedded_vault():
    ret = TestAnsibleLoaderVault().test_embedded_vault()

def test_TestAnsibleLoaderPlay_setUp():
    ret = TestAnsibleLoaderPlay().setUp()

def test_TestAnsibleLoaderPlay_tearDown():
    ret = TestAnsibleLoaderPlay().tearDown()

def test_TestAnsibleLoaderPlay_test_data_complete():
    ret = TestAnsibleLoaderPlay().test_data_complete()

def test_TestAnsibleLoaderPlay_walk():
    ret = TestAnsibleLoaderPlay().walk()

def test_TestAnsibleLoaderPlay_test_no_str_in_data():
    ret = TestAnsibleLoaderPlay().test_no_str_in_data()

def test_TestAnsibleLoaderPlay_check_vars():
    ret = TestAnsibleLoaderPlay().check_vars()

def test_TestAnsibleLoaderPlay_check_tasks():
    ret = TestAnsibleLoaderPlay().check_tasks()

def test_TestAnsibleLoaderPlay_test_line_numbers():
    ret = TestAnsibleLoaderPlay().test_line_numbers()