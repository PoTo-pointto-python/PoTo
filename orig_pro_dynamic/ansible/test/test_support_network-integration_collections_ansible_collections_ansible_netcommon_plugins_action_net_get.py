...
def test_ActionModule__handle_dest_path():
    ret = ActionModule()._handle_dest_path()

def test_ActionModule__get_src_filename_from_path():
    ret = ActionModule()._get_src_filename_from_path()

def test_ActionModule__get_default_dest():
    ret = ActionModule()._get_default_dest()
