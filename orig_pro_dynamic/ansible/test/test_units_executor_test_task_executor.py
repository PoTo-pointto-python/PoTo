...
class TestTaskExecutor(unittest.TestCase):
    ...
    def test_task_executor_init(self):
        ...
        te = TaskExecutor(host=mock_host, task=mock_task, job_vars=job_vars, play_context=mock_play_context, new_stdin=new_stdin, loader=fake_loader, shared_loader_obj=mock_shared_loader, final_q=mock_queue)
    ...
    def test_task_executor_get_action_handler(self):
        te = TaskExecutor(host=MagicMock(), task=MagicMock(), job_vars={}, play_context=MagicMock(), new_stdin=None, loader=DictDataLoader({}), shared_loader_obj=MagicMock(), final_q=MagicMock())
        ...
        action_loader.get.assert_called_once_with(te._task.action, task=te._task, connection=mock_connection, play_context=te._play_context, loader=te._loader, templar=mock_templar, shared_loader_obj=te._shared_loader_obj, collection_list=te._task.collections)
    ...
    def test_task_executor_get_handler_prefix(self):
        ...
        action_loader.get.assert_called_once_with(module_prefix, task=te._task, connection=mock_connection, play_context=te._play_context, loader=te._loader, templar=mock_templar, shared_loader_obj=te._shared_loader_obj, collection_list=te._task.collections)
    ...
    def test_task_executor_get_handler_normal(self):
        ...
        self.assertIs(mock.sentinel.handler, handler)
        action_loader.has_plugin.assert_has_calls([mock.call(action, collection_list=te._task.collections), mock.call(module_prefix, collection_list=te._task.collections)])
        action_loader.get.assert_called_once_with('ansible.legacy.normal', task=te._task, connection=mock_connection, play_context=te._play_context, loader=te._loader, templar=mock_templar, shared_loader_obj=te._shared_loader_obj, collection_list=None)
    ...
    def test_task_executor_execute(self):
        ...
        te = TaskExecutor(host=mock_host, task=mock_task, job_vars=job_vars, play_context=mock_play_context, new_stdin=new_stdin, loader=fake_loader, shared_loader_obj=shared_loader, final_q=mock_queue)
...
def test_TestTaskExecutor_test_task_executor_init():
    ret = TestTaskExecutor().test_task_executor_init()

def test_TestTaskExecutor_test_task_executor_run():
    ret = TestTaskExecutor().test_task_executor_run()

def test_TestTaskExecutor_test_task_executor_run_clean_res():
    ret = TestTaskExecutor().test_task_executor_run_clean_res()

def test_TestTaskExecutor_test_task_executor_get_loop_items():
    ret = TestTaskExecutor().test_task_executor_get_loop_items()

def test_TestTaskExecutor__copy():
    ret = TestTaskExecutor()._copy()

def test_TestTaskExecutor__execute():
    ret = TestTaskExecutor()._execute()

def test_TestTaskExecutor_test_task_executor_run_loop():
    ret = TestTaskExecutor().test_task_executor_run_loop()

def test_TestTaskExecutor_test_task_executor_get_action_handler():
    ret = TestTaskExecutor().test_task_executor_get_action_handler()

def test_TestTaskExecutor_test_task_executor_get_handler_prefix():
    ret = TestTaskExecutor().test_task_executor_get_handler_prefix()

def test_TestTaskExecutor_test_task_executor_get_handler_normal():
    ret = TestTaskExecutor().test_task_executor_get_handler_normal()

def test_TestTaskExecutor_test_task_executor_execute():
    ret = TestTaskExecutor().test_task_executor_execute()

def test_TestTaskExecutor__get():
    ret = TestTaskExecutor()._get()

def test_TestTaskExecutor__get():
    ret = TestTaskExecutor()._get()

def test_TestTaskExecutor_test_task_executor_poll_async_result():
    ret = TestTaskExecutor().test_task_executor_poll_async_result()

def test_TestTaskExecutor_test_recursive_remove_omit():
    ret = TestTaskExecutor().test_recursive_remove_omit()