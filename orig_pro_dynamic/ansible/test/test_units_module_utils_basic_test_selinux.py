...
class TestSELinux(ModuleTestCase):
    ...
    def test_module_utils_basic_ansible_module_is_special_selinux_path(self):
        from ansible.module_utils import basic
        args = json.dumps(dict(ANSIBLE_MODULE_ARGS={'_ansible_selinux_special_fs': 'nfs,nfsd,foos', '_ansible_remote_tmp': '/tmp', '_ansible_keep_remote_files': False}))
...
def test_TestSELinux_test_module_utils_basic_ansible_module_selinux_mls_enabled():
    ret = TestSELinux().test_module_utils_basic_ansible_module_selinux_mls_enabled()

def test_TestSELinux_test_module_utils_basic_ansible_module_selinux_initial_context():
    ret = TestSELinux().test_module_utils_basic_ansible_module_selinux_initial_context()

def test_TestSELinux_test_module_utils_basic_ansible_module_selinux_enabled():
    ret = TestSELinux().test_module_utils_basic_ansible_module_selinux_enabled()

def test_TestSELinux_test_module_utils_basic_ansible_module_selinux_default_context():
    ret = TestSELinux().test_module_utils_basic_ansible_module_selinux_default_context()

def test_TestSELinux_test_module_utils_basic_ansible_module_selinux_context():
    ret = TestSELinux().test_module_utils_basic_ansible_module_selinux_context()

def test_TestSELinux__mock_find_mount_point():
    ret = TestSELinux()._mock_find_mount_point()

def test_TestSELinux_test_module_utils_basic_ansible_module_is_special_selinux_path():
    ret = TestSELinux().test_module_utils_basic_ansible_module_is_special_selinux_path()

def test_TestSELinux_test_module_utils_basic_ansible_module_set_context_if_different():
    ret = TestSELinux().test_module_utils_basic_ansible_module_set_context_if_different()