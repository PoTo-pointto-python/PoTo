...
from ..sanity import SanitySingleVersion, SanityFailure, SanitySuccess
from ..target import TestTarget
from ..util import SubprocessError, display, is_subdir
from ..util_common import intercept_command
...
class AnsibleDocTest(SanitySingleVersion):
    ...
    def filter_targets(self, targets): # type: (t.List[TestTarget]) -> t.List[TestTarget]
        ...
        unsupported_plugin_types = set(['action', 'doc_fragments', 'filter', 'module_utils', 'terminal', 'test'])
...
def test_AnsibleDocTest_filter_targets():
    ret = AnsibleDocTest().filter_targets()

def test_AnsibleDocTest_test():
    ret = AnsibleDocTest().test()