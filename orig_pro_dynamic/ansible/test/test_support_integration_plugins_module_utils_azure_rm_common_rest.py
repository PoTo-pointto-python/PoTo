...
def test_GenericRestClient_get_long_running_output():
    ret = GenericRestClient().get_long_running_output()

def test_GenericRestClient_query():
    ret = GenericRestClient().query()

def test_GenericRestClient_get_poller_result():
    ret = GenericRestClient().get_poller_result()