...
class TestFactsLinuxHardwareGetMountFacts(unittest.TestCase):
    ...
    def test_get_mount_facts(self, mock_lsblk_uuid, mock_find_bind_mounts, mock_mtab_entries, mock_udevadm_uuid):
        module = Mock()
...
def test_BaseTestFactsPlatform_test_new():
    ret = BaseTestFactsPlatform().test_new()

def test_BaseTestFactsPlatform_test_subclass():
    ret = BaseTestFactsPlatform().test_subclass()

def test_BaseTestFactsPlatform_test_collector():
    ret = BaseTestFactsPlatform().test_collector()
