...
def test_TestAnsibleDumper_setUp():
    ret = TestAnsibleDumper().setUp()

def test_TestAnsibleDumper__build_stream():
    ret = TestAnsibleDumper()._build_stream()

def test_TestAnsibleDumper__loader():
    ret = TestAnsibleDumper()._loader()

def test_TestAnsibleDumper_test_ansible_vault_encrypted_unicode():
    ret = TestAnsibleDumper().test_ansible_vault_encrypted_unicode()

def test_TestAnsibleDumper_test_bytes():
    ret = TestAnsibleDumper().test_bytes()

def test_TestAnsibleDumper_test_unicode():
    ret = TestAnsibleDumper().test_unicode()