...
def cliargs(collections_paths=None, collection_name=None):
    ...
    context.CLIARGS._store = {'collections_path': collections_paths, 'collection': collection_name, 'type': 'collection'}
...
def test_execute_list_collection_all(mocker, capsys, mock_collection_objects):
    mock_collection_objects = mock_collection_objects()
