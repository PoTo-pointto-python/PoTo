...
def test_ActionModule__create_content_tempfile():
    ret = ActionModule()._create_content_tempfile()

def test_ActionModule__create_zip_tempfile():
    ret = ActionModule()._create_zip_tempfile()

def test_ActionModule__remove_tempfile_if_content_defined():
    ret = ActionModule()._remove_tempfile_if_content_defined()

def test_ActionModule__copy_single_file():
    ret = ActionModule()._copy_single_file()

def test_ActionModule__copy_zip_file():
    ret = ActionModule()._copy_zip_file()
