...
def test_TestVariableManager_test_basic_manager():
    ret = TestVariableManager().test_basic_manager()

def test_TestVariableManager_test_variable_manager_extra_vars():
    ret = TestVariableManager().test_variable_manager_extra_vars()

def test_TestVariableManager_test_variable_manager_options_vars():
    ret = TestVariableManager().test_variable_manager_options_vars()

def test_TestVariableManager_test_variable_manager_play_vars():
    ret = TestVariableManager().test_variable_manager_play_vars()

def test_TestVariableManager_test_variable_manager_play_vars_files():
    ret = TestVariableManager().test_variable_manager_play_vars_files()

def test_TestVariableManager_test_variable_manager_task_vars():
    ret = TestVariableManager().test_variable_manager_task_vars()

def test_TestVariableManager_test_variable_manager_precedence():
    ret = TestVariableManager().test_variable_manager_precedence()

def test_TestVariableManager_test_variable_manager_role_vars_dependencies():
    ret = TestVariableManager().test_variable_manager_role_vars_dependencies()