...
def get_connector(*args, **kwargs):
    ...
    if not HAS_INFOBLOX_CLIENT:
        raise Exception('infoblox-client is required but does not appear to be installed.  It can be installed using the command `pip install infoblox-client`')
...
def test_WapiBase___getattr__():
    ret = WapiBase().__getattr__()

def test_WapiBase__invoke_method():
    ret = WapiBase()._invoke_method()

def test_WapiLookup_handle_exception():
    ret = WapiLookup().handle_exception()

def test_WapiModule_handle_exception():
    ret = WapiModule().handle_exception()

def test_WapiModule_run():
    ret = WapiModule().run()

def test_WapiModule_check_if_recordname_exists():
    ret = WapiModule().check_if_recordname_exists()

def test_WapiModule_check_if_nios_next_ip_exists():
    ret = WapiModule().check_if_nios_next_ip_exists()

def test_WapiModule_check_if_add_remove_ip_arg_exists():
    ret = WapiModule().check_if_add_remove_ip_arg_exists()

def test_WapiModule_issubset():
    ret = WapiModule().issubset()

def test_WapiModule_compare_objects():
    ret = WapiModule().compare_objects()

def test_WapiModule_get_object_ref():
    ret = WapiModule().get_object_ref()

def test_WapiModule_on_update():
    ret = WapiModule().on_update()