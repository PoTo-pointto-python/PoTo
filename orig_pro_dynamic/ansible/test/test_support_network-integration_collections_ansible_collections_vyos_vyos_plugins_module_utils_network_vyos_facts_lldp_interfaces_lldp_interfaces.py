...
def test_Lldp_interfacesFacts_populate_facts():
    ret = Lldp_interfacesFacts().populate_facts()

def test_Lldp_interfacesFacts_render_config():
    ret = Lldp_interfacesFacts().render_config()

def test_Lldp_interfacesFacts_parse_attribs():
    ret = Lldp_interfacesFacts().parse_attribs()

def test_Lldp_interfacesFacts_parse_lldp_civic_based():
    ret = Lldp_interfacesFacts().parse_lldp_civic_based()

def test_Lldp_interfacesFacts_parse_lldp_elin_based():
    ret = Lldp_interfacesFacts().parse_lldp_elin_based()