...
def test_TestFacterCollector__mock_module():
    ret = TestFacterCollector()._mock_module()

def test_TestFacterCollector_test_bogus_json():
    ret = TestFacterCollector().test_bogus_json()

def test_TestFacterCollector_test_facter_non_zero_return_code():
    ret = TestFacterCollector().test_facter_non_zero_return_code()