...
def test_PgMembership_grant():
    ret = PgMembership().grant()

def test_PgMembership_revoke():
    ret = PgMembership().revoke()

def test_PgMembership___check_membership():
    ret = PgMembership().__check_membership()

def test_PgMembership___check_roles_exist():
    ret = PgMembership().__check_roles_exist()

def test_PgMembership___roles_exist():
    ret = PgMembership().__roles_exist()