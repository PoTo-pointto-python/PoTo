...
def test_KnownHostsDiffTestCase__create_file():
    ret = KnownHostsDiffTestCase()._create_file()

def test_KnownHostsDiffTestCase_test_no_existing_file():
    ret = KnownHostsDiffTestCase().test_no_existing_file()

def test_KnownHostsDiffTestCase_test_key_addition():
    ret = KnownHostsDiffTestCase().test_key_addition()

def test_KnownHostsDiffTestCase_test_no_change():
    ret = KnownHostsDiffTestCase().test_no_change()

def test_KnownHostsDiffTestCase_test_key_change():
    ret = KnownHostsDiffTestCase().test_key_change()

def test_KnownHostsDiffTestCase_test_key_removal():
    ret = KnownHostsDiffTestCase().test_key_removal()

def test_KnownHostsDiffTestCase_test_key_removal_no_change():
    ret = KnownHostsDiffTestCase().test_key_removal_no_change()

def test_KnownHostsDiffTestCase_test_sanity_check():
    ret = KnownHostsDiffTestCase().test_sanity_check()