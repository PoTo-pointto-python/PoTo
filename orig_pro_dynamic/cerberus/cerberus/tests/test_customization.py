...
def a():
    test_schema_validation_can_be_disabled(UnconcernedValidator)
...
def PT_test_test_schema_validation_can_be_disabled_1():
    v = UnconcernedValidator(schema=sample_schema)
    assert v.validate(document={'an_integer': 1})
    assert not v.validate(document={'an_integer': 'a'})
...
def PT_test_test_schema_validation_can_be_disabled_2():
    v = cerberus.validator_factory('NonvalidatingValidator', validated_schema=False)(schema=sample_schema)
    assert v.validate(document={'an_integer': 1})
    assert not v.validate(document={'an_integer': 'a'})
