...
@pytest.mark.skip(reason='not exist')
def main():
...
def test_PT_testbot_not_async_on_step():
    tb = TestBot()
    tb.on_step(5)

def test_PT_testbot_not_async_test_botai_properties():
    tb = TestBot()
    tb.test_botai_properties()

def test_PT_testbot_not_async_test_botai_actions1():
    tb = TestBot()
    tb.test_botai_actions1()

def test_PT_testbot_not_async_test_botai_actions2():
    tb = TestBot()
    tb.test_botai_actions2()

def test_PT_testbot_not_async_test_botai_actions3():
    tb = TestBot()
    tb.test_botai_actions3()

def test_PT_testbot_not_async_test_botai_actions4():
    tb = TestBot()
    tb.test_botai_actions4()

def test_PT_testbot_not_async_test_botai_actions5():
    tb = TestBot()
    tb.test_botai_actions5()

def test_PT_testbot_not_async_test_botai_actions1_successful():
    tb = TestBot()
    tb.test_botai_actions1_successful()

def test_PT_testbot_not_async_test_botai_actions2_successful():
    tb = TestBot()
    tb.test_botai_actions2_successful()

def test_PT_testbot_not_async_test_botai_actions3_successful():
    tb = TestBot()
    tb.test_botai_actions3_successful()

def test_PT_testbot_not_async_test_botai_actions4_successful():
    tb = TestBot()
    tb.test_botai_actions4_successful()

def test_PT_testbot_not_async_test_botai_actions5_successful():
    tb = TestBot()
    tb.test_botai_actions5_successful()

def test_PT_testbot_not_async_test_game_info_static_variables():
    tb = TestBot()
    tb.test_game_info_static_variables()

def test_PT_testbot_not_async_test_positions():
    tb = TestBot()
    tb.test_positions()

def test_PT_testbot_not_async_test_unit():
    tb = TestBot()
    tb.test_unit()

def test_PT_testbot_not_async_test_units():
    tb = TestBot()
    tb.test_units()



### END EDIT FOR PT_analysis
