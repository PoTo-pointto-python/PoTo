...
@pytest.mark.parametrize('code', [function_first_argument, method_first_argument, classmethod_first_argument, meta_first_argument])
def test_correct_first_arguments(assert_errors, parse_ast_tree, argument, code, default_options, mode):
    argument = SPECIAL_ARGUMENT_NAMES_WHITELIST[0]
    code = function_first_argument
