import pytest
from wemake_python_styleguide.violations.consistency import LocalFolderImportViolation
...
@pytest.mark.parametrize('code', [same_level_relative_import, same_level_relative_import_sibling, parent_level_relative_import, parent_level_relative_import_sibling, grand_level_relative_import_sibling])
def test_local_folder_import(assert_errors, parse_ast_tree, code, default_options):
    code = same_level_relative_import
...
@pytest.mark.parametrize('code', [regular_import, regular_from_import, regular_nested_import])
