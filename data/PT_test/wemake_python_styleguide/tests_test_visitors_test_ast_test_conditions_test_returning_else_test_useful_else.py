...
@pytest.mark.parametrize('code', [correct_example1, correct_example2, correct_example3, correct_example4, correct_example5, correct_example6, correct_example7, correct_example8, correct_example9, correct_example10, correct_example11, correct_example12, correct_example13])
def test_else_that_can_not_be_removed(assert_errors, parse_ast_tree, code, default_options, mode):
