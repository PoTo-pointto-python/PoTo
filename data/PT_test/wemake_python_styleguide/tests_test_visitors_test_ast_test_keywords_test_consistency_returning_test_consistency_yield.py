import pytest
from wemake_python_styleguide.violations.consistency import InconsistentYieldViolation
...
@pytest.mark.parametrize('code', [wrong_example1, wrong_example2, wrong_example3])
def test_wrong_yield_statement(assert_errors, parse_ast_tree, code, default_options, mode):
    code = wrong_example1
...
@pytest.mark.parametrize('code', [correct_example1, correct_example2, correct_example3, correct_example4, correct_example5, correct_example6])
def test_correct_yield_statements(assert_errors, parse_ast_tree, code, default_options, mode):
