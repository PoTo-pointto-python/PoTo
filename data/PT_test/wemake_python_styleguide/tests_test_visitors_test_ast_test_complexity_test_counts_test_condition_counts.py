import pytest
from wemake_python_styleguide.violations.complexity import TooManyConditionsViolation
...
@pytest.mark.parametrize('code', [empty_module, assignment, condition_with_single_if, condition_with_single_if_multiline, condition_with_several_ifs, condition_with_several_elifs, condition_inline, condition_with_inline_for, condition_with_simple_inline_for, while_with_condition])
def test_module_condition_counts_normal(assert_errors, parse_ast_tree, code, default_options):
    code = empty_module
...
@pytest.mark.parametrize('code', [complex_assignment, complex_condition, complex_while])
def test_module_condition_real_config(assert_errors, assert_error_text, parse_ast_tree, default_options, code):
