...
@pytest.mark.parametrize('code', [correct_assignment, correct_if_condition, correct_comprehension])
def test_not_walrus(assert_errors, parse_ast_tree, code, default_options):
...
@pytest.mark.parametrize('code', [wrong_assignment, wrong_if_condition, wrong_comprehension])
def test_walrus(assert_errors, parse_ast_tree, code, default_options):
    code = wrong_assignment
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
