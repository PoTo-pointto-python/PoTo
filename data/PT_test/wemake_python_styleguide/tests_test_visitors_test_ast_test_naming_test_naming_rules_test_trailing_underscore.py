import pytest
from wemake_python_styleguide.violations.naming import TrailingUnderscoreViolation
from wemake_python_styleguide.visitors.ast.naming import WrongNameVisitor

def test_wrong_trailing_underscore(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode):
...
@pytest.mark.parametrize('correct_name', ['list_', 'class_', 'async_', 'await_'])
def test_correct_trailing_underscore(assert_errors, parse_ast_tree, naming_template, default_options, correct_name, mode):
    correct_name = 'list_'
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    naming_template = naming_template()
