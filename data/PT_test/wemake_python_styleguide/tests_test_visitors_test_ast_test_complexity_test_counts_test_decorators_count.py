import pytest
from wemake_python_styleguide.violations.complexity import TooManyDecoratorsViolation
...
@pytest.mark.parametrize('code', [function_with_decorators, class_with_decorators, method_with_decorators, classmethod_with_decorators])
def test_decorators_normal(assert_errors, parse_ast_tree, code, default_options, mode):
    code = function_with_decorators
...
@pytest.mark.parametrize('code', [function_with_decorators, class_with_decorators, method_with_decorators, classmethod_with_decorators])
def test_decorators_incorrect(assert_errors, assert_error_text, parse_ast_tree, code, options, mode):
    code = function_with_decorators
    assert_errors = assert_errors()
