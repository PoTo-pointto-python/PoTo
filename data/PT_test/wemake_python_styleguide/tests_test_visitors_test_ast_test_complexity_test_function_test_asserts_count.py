import pytest
from wemake_python_styleguide.violations.complexity import TooManyAssertsViolation
...
@pytest.mark.parametrize('code', [function_without_asserts, function_with_asserts, function_with_nested_function_and_asserts])
def test_asserts_correct_count(assert_errors, parse_ast_tree, code, default_options):
    code = function_without_asserts
...
@pytest.mark.parametrize('code', [function_with_asserts, function_with_nested_function_and_asserts])
def test_asserts_wrong_count(assert_errors, assert_error_text, parse_ast_tree, options, code):
    code = function_with_asserts
    assert_errors = assert_errors()
