...
@pytest.mark.parametrize('expression', ['1.0', '-0.0', '+3.5'])
def test_float_key_usage(assert_errors, parse_ast_tree, expression, default_options):
    expression = '1.0'
...
@pytest.mark.parametrize('expression', ['5', 'name', 'call()', 'name.attr', 'name[sub]', '...', '"str"', 'b""', '3j', '5 + 0.1', '3 / 2'])
