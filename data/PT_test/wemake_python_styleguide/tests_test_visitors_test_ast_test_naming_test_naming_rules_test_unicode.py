...
@pytest.mark.parametrize('wrong_name', ['тестовое_имя', 'test_имя2', 'сос', 'some_變量'])
def test_wrong_unicode(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode, wrong_name):
    wrong_name = 'тестовое_имя'
