...
from wemake_python_styleguide.violations.naming import WrongModuleMagicNameViolation
...
def test_correct_magic_filename(assert_errors, filename, default_options):
    filename = MAGIC_MODULE_NAMES_WHITELIST[0]
...
@pytest.mark.parametrize('filename', ['__version__.py', '__custom__.py', '__some_extra__.py'])
