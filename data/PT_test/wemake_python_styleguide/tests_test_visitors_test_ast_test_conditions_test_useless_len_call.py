...
@pytest.mark.parametrize('code', [correct_call1, correct_call2, correct_call3])
def test_useful_len_call(assert_errors, parse_ast_tree, code, default_options):
    code = correct_call1
...
@pytest.mark.parametrize('code', [wrong_len_call1, wrong_len_call2])
def test_useless_len_call(assert_errors, parse_ast_tree, code, default_options):
    code = wrong_len_call1
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
