...
@pytest.mark.parametrize('wrong_name', ['list', 'str', 'sum'])
def test_builtin_shadowing(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode, wrong_name):
    wrong_name = 'list'
