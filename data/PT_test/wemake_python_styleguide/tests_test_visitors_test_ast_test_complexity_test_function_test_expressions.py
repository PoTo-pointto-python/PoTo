import pytest
from wemake_python_styleguide.violations.complexity import TooManyExpressionsViolation
...
@pytest.mark.parametrize('code', [function_without_expressions, function_with_expressions, function_with_nested_function_and_expressions])
def test_expressions_correct_count(assert_errors, parse_ast_tree, code, default_options, mode):
...
@pytest.mark.parametrize('code', [function_with_expressions, function_with_nested_function_and_expressions])
def test_expressions_wrong_count(assert_errors, assert_error_text, parse_ast_tree, options, code, mode):
    code = function_with_expressions
    assert_errors = assert_errors()
