...
@pytest.mark.parametrize('code', [correct_single_line_class, correct_multi_line_class, correct_multi_line_class_with_keywords, correct_next_line_class])
def test_correct_class_indentation(assert_errors, parse_ast_tree, code, default_options):
    code = correct_single_line_class
...
@pytest.mark.parametrize('code', [wrong_class_indentation1, wrong_class_indentation2, wrong_class_indentation3, wrong_class_indentation4, wrong_class_indentation5, wrong_class_indentation6])
def test_wrong_class_indentation(assert_errors, parse_ast_tree, code, default_options):
    code = wrong_class_indentation1
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
