...
@pytest.mark.parametrize('underscored_name', ['with__underscore', 'mutliple__under__score', 'triple___underscore', '__magic__name__'])
def test_underscored_variable_name(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode, underscored_name):
    underscored_name = 'with__underscore'
