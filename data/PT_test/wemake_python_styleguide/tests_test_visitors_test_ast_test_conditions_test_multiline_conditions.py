import pytest
from wemake_python_styleguide.violations.consistency import MultilineConditionsViolation
...
@pytest.mark.parametrize('code', [incorrect_conditions1, incorrect_conditions2, incorrect_conditions3, incorrect_conditions4, incorrect_conditions5])
def test_incorrect_multiline_conditions(assert_errors, parse_ast_tree, code, default_options, mode):
    code = incorrect_conditions1
...
@pytest.mark.parametrize('code', [correct_conditions1, correct_conditions2, correct_conditions3, correct_conditions4])
def test_correct_multiline_conditions(assert_errors, parse_ast_tree, code, default_options, mode):
