import pytest
from wemake_python_styleguide.violations.complexity import TooManyAwaitsViolation
...
@pytest.mark.parametrize('code', [function_without_awaits, function_async_without_awaits, function_with_awaits, function_with_nested_function_and_awaits])
def test_awaits_correct_count(assert_errors, parse_ast_tree, code, default_options):
    code = function_without_awaits
...
@pytest.mark.parametrize('code', [function_with_awaits, function_with_nested_function_and_awaits])
def test_awaits_wrong_count(assert_errors, assert_error_text, parse_ast_tree, options, code):
    code = function_with_awaits
    assert_errors = assert_errors()
