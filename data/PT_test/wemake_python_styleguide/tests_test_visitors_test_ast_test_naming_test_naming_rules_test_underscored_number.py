...
@pytest.mark.parametrize('number_suffix', ['number_5', 'between_45_letters', 'with_multiple_groups_4_5'])
def test_number_prefix_variable_name(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode, number_suffix):
