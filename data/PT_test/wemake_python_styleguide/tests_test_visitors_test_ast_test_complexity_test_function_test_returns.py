import pytest
from wemake_python_styleguide.violations.complexity import TooManyReturnsViolation
...
@pytest.mark.parametrize('code', [function_without_returns, function_with_returns, function_with_nested_function_and_returns])
def test_returns_correct_count(assert_errors, parse_ast_tree, code, default_options, mode):
...
@pytest.mark.parametrize('code', [function_with_returns, function_with_nested_function_and_returns])
def test_returns_wrong_count(assert_errors, assert_error_text, parse_ast_tree, options, code, mode):
    code = function_with_returns
    assert_errors = assert_errors()
