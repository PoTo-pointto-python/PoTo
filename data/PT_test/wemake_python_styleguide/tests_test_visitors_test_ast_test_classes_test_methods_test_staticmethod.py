...
def test_staticmethod_used(assert_errors, parse_ast_tree, default_options, mode):
...
@pytest.mark.parametrize('decorator', ['classmethod', 'custom', 'with_params(12, 100)'])
def test_regular_decorator_used(assert_errors, parse_ast_tree, decorator, default_options, mode):
