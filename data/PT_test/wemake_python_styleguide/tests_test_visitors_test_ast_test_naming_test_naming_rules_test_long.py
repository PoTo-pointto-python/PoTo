...
def test_long_variable_name(assert_errors, assert_error_text, parse_ast_tree, naming_template, default_options, mode):
...
def test_long_variable_name_config(assert_errors, parse_ast_tree, naming_template, options, mode):
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    naming_template = naming_template()
    options = options()
