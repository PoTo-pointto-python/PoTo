...
@pytest.mark.parametrize('comparators', [('variable', '"test"'), ('12', 'variable.call()'), ('False', 'len(variable)'), ('False', 'None'), ('True', '222'), ('True', 'None')])
def test_not_simplifiable_exp(assert_errors, parse_ast_tree, comparators, default_options):
...
def test_simplifiable_exp(assert_errors, parse_ast_tree, comparators, default_options):
