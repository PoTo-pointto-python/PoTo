...
@pytest.mark.parametrize('code', [complex_loop_comprehension, complex_dict_comprehension, complex_gen_expression])
def test_multiple_for_keywords_in_comprehension(assert_errors, parse_ast_tree, code, default_options):
    code = complex_loop_comprehension
...
@pytest.mark.parametrize('code', [complex_nested_list_comprehension])
def test_multiple_fors_in_async_comprehension(assert_errors, parse_ast_tree, code, default_options, mode):
    code = complex_nested_list_comprehension
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
    mode = mode()
...
@pytest.mark.parametrize('code', [regular_loop_comprehension, regular_dict_comprehension, regular_gen_expression])
def test_regular_fors_in_comprehension(assert_errors, parse_ast_tree, code, default_options):
    code = regular_loop_comprehension
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
...
@pytest.mark.parametrize('code', [regular_nested_list_comprehension])
def test_regular_fors_in_async_comprehension(assert_errors, parse_ast_tree, code, default_options, mode):
    code = regular_nested_list_comprehension
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
    mode = mode()
