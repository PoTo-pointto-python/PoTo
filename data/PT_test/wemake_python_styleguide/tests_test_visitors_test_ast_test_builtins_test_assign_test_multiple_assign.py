import pytest
from wemake_python_styleguide.violations.best_practices import MultipleAssignmentsViolation
...
@pytest.mark.parametrize('code', [single_assignment, tuple_assignment, spread_assignment])
def test_correct_assignments(assert_errors, parse_ast_tree, code, default_options):
...
@pytest.mark.parametrize('code', [two_assignment, three_assignment])
def test_multiple_assignments(assert_errors, parse_ast_tree, code, default_options):
    code = two_assignment
    assert_errors = assert_errors()
    parse_ast_tree = parse_ast_tree()
    default_options = default_options()
