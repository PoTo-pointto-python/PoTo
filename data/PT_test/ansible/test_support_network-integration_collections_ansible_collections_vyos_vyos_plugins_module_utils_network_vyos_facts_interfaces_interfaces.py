...
class InterfacesFacts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        objs = []
        interface_names = findall("^set interfaces (?:ethernet|bonding|vti|loopback|vxlan) (?:\\'*)(\\S+)(?:\\'*)", data, M)
        if interface_names:
...
def test_InterfacesFacts_populate_facts():
    ret = InterfacesFacts().populate_facts()

def test_InterfacesFacts_render_config():
    ret = InterfacesFacts().render_config()

def test_InterfacesFacts_parse_vifs():
    ret = InterfacesFacts().parse_vifs()

def test_InterfacesFacts_parse_attribs():
    ret = InterfacesFacts().parse_attribs()