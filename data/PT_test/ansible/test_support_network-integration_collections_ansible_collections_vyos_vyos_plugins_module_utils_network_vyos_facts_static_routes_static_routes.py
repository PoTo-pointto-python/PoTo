...
def test_Static_routesFacts_get_device_data():
    ret = Static_routesFacts().get_device_data()

def test_Static_routesFacts_populate_facts():
    ret = Static_routesFacts().populate_facts()

def test_Static_routesFacts_render_config():
    ret = Static_routesFacts().render_config()

def test_Static_routesFacts_parse_blackhole():
    ret = Static_routesFacts().parse_blackhole()

def test_Static_routesFacts_get_afi():
    ret = Static_routesFacts().get_afi()

def test_Static_routesFacts_parse_next_hop():
    ret = Static_routesFacts().parse_next_hop()