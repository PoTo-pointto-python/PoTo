...
def test_L3_interfacesFacts_populate_facts():
    ret = L3_interfacesFacts().populate_facts()

def test_L3_interfacesFacts_render_config():
    ret = L3_interfacesFacts().render_config()

def test_L3_interfacesFacts_parse_vifs():
    ret = L3_interfacesFacts().parse_vifs()

def test_L3_interfacesFacts_parse_attribs():
    ret = L3_interfacesFacts().parse_attribs()