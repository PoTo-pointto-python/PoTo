...
class TestGetCollectorNames(unittest.TestCase):
    ...
    def test_invaid_gather_subset(self):
        ...
        minimal_gather_subset = frozenset(['my_fact'])
        self.assertRaisesRegexp(TypeError, 'Bad subset .* given to Ansible.*allowed\\:.*all,.*my_fact.*', collector.get_collector_names, valid_subsets=valid_subsets, minimal_gather_subset=minimal_gather_subset, gather_subset=['my_fact', 'not_a_valid_gather_subset'])
...
class TestResolveRequires(unittest.TestCase):
    ...
    def test_no_resolution(self):
        ...
        all_fact_subsets = {'env': [default_collectors.EnvFactCollector], 'network': [default_collectors.LinuxNetworkCollector], 'virtual': [default_collectors.LinuxVirtualCollector]}
        self.assertRaisesRegexp(collector.UnresolvedFactDep, 'unresolved fact dep.*required_thing2', collector.resolve_requires, unresolved, all_fact_subsets)
...
class TestCollectorClassesFromGatherSubset(unittest.TestCase):
    ...
    def test_unknown_collector(self):
        self.assertRaisesRegexp(TypeError, 'Bad subset.*unknown_collector.*given to Ansible.*allowed\\:.*all,.*env.*', self._classes, all_collector_classes=default_collectors.collectors, gather_subset=['env', 'unknown_collector'])

def test_TestFindCollectorsForPlatform_test():
    ret = TestFindCollectorsForPlatform().test()

def test_TestFindCollectorsForPlatform_test_linux():
    ret = TestFindCollectorsForPlatform().test_linux()

def test_TestFindCollectorsForPlatform_test_linux_or_generic():
    ret = TestFindCollectorsForPlatform().test_linux_or_generic()

def test_TestSelectCollectorNames__assert_equal_detail():
    ret = TestSelectCollectorNames()._assert_equal_detail()

def test_TestSelectCollectorNames_test():
    ret = TestSelectCollectorNames().test()

def test_TestSelectCollectorNames_test_default_collectors():
    ret = TestSelectCollectorNames().test_default_collectors()

def test_TestSelectCollectorNames__all_fact_subsets():
    ret = TestSelectCollectorNames()._all_fact_subsets()

def test_TestGetCollectorNames_test_none():
    ret = TestGetCollectorNames().test_none()

def test_TestGetCollectorNames_test_empty_sets():
    ret = TestGetCollectorNames().test_empty_sets()

def test_TestGetCollectorNames_test_empty_valid_and_min_with_all_gather_subset():
    ret = TestGetCollectorNames().test_empty_valid_and_min_with_all_gather_subset()

def test_TestGetCollectorNames_test_one_valid_with_all_gather_subset():
    ret = TestGetCollectorNames().test_one_valid_with_all_gather_subset()

def test_TestGetCollectorNames__compare_res():
    ret = TestGetCollectorNames()._compare_res()

def test_TestGetCollectorNames_test_not_all_other_order():
    ret = TestGetCollectorNames().test_not_all_other_order()

def test_TestGetCollectorNames_test_not_all_other_order_min():
    ret = TestGetCollectorNames().test_not_all_other_order_min()

def test_TestGetCollectorNames_test_one_minimal_with_all_gather_subset():
    ret = TestGetCollectorNames().test_one_minimal_with_all_gather_subset()

def test_TestGetCollectorNames_test_with_all_gather_subset():
    ret = TestGetCollectorNames().test_with_all_gather_subset()

def test_TestGetCollectorNames_test_one_minimal_with_not_all_gather_subset():
    ret = TestGetCollectorNames().test_one_minimal_with_not_all_gather_subset()

def test_TestGetCollectorNames_test_gather_subset_excludes():
    ret = TestGetCollectorNames().test_gather_subset_excludes()

def test_TestGetCollectorNames_test_gather_subset_excludes_ordering():
    ret = TestGetCollectorNames().test_gather_subset_excludes_ordering()

def test_TestGetCollectorNames_test_gather_subset_excludes_min():
    ret = TestGetCollectorNames().test_gather_subset_excludes_min()

def test_TestGetCollectorNames_test_gather_subset_excludes_min_and_all():
    ret = TestGetCollectorNames().test_gather_subset_excludes_min_and_all()

def test_TestGetCollectorNames_test_invaid_gather_subset():
    ret = TestGetCollectorNames().test_invaid_gather_subset()

def test_TestFindUnresolvedRequires_test():
    ret = TestFindUnresolvedRequires().test()

def test_TestFindUnresolvedRequires_test_resolved():
    ret = TestFindUnresolvedRequires().test_resolved()

def test_TestBuildDepData_test():
    ret = TestBuildDepData().test()

def test_TestSolveDeps_test_no_solution():
    ret = TestSolveDeps().test_no_solution()

def test_TestSolveDeps_test():
    ret = TestSolveDeps().test()

def test_TestResolveRequires_test_no_resolution():
    ret = TestResolveRequires().test_no_resolution()

def test_TestResolveRequires_test():
    ret = TestResolveRequires().test()

def test_TestResolveRequires_test_exception():
    ret = TestResolveRequires().test_exception()

def test_TestTsort_test():
    ret = TestTsort().test()

def test_TestTsort_test_cycles():
    ret = TestTsort().test_cycles()

def test_TestTsort_test_just_nodes():
    ret = TestTsort().test_just_nodes()

def test_TestTsort_test_self_deps():
    ret = TestTsort().test_self_deps()

def test_TestTsort_test_unsolvable():
    ret = TestTsort().test_unsolvable()

def test_TestTsort_test_chain():
    ret = TestTsort().test_chain()

def test_TestTsort_test_multi_pass():
    ret = TestTsort().test_multi_pass()

def test_TestCollectorClassesFromGatherSubset__classes():
    ret = TestCollectorClassesFromGatherSubset()._classes()

def test_TestCollectorClassesFromGatherSubset_test_no_args():
    ret = TestCollectorClassesFromGatherSubset().test_no_args()

def test_TestCollectorClassesFromGatherSubset_test_not_all():
    ret = TestCollectorClassesFromGatherSubset().test_not_all()

def test_TestCollectorClassesFromGatherSubset_test_all():
    ret = TestCollectorClassesFromGatherSubset().test_all()

def test_TestCollectorClassesFromGatherSubset_test_hardware():
    ret = TestCollectorClassesFromGatherSubset().test_hardware()

def test_TestCollectorClassesFromGatherSubset_test_network():
    ret = TestCollectorClassesFromGatherSubset().test_network()

def test_TestCollectorClassesFromGatherSubset_test_env():
    ret = TestCollectorClassesFromGatherSubset().test_env()

def test_TestCollectorClassesFromGatherSubset_test_facter():
    ret = TestCollectorClassesFromGatherSubset().test_facter()

def test_TestCollectorClassesFromGatherSubset_test_facter_ohai():
    ret = TestCollectorClassesFromGatherSubset().test_facter_ohai()

def test_TestCollectorClassesFromGatherSubset_test_just_facter():
    ret = TestCollectorClassesFromGatherSubset().test_just_facter()

def test_TestCollectorClassesFromGatherSubset_test_collector_specified_multiple_times():
    ret = TestCollectorClassesFromGatherSubset().test_collector_specified_multiple_times()

def test_TestCollectorClassesFromGatherSubset_test_unknown_collector():
    ret = TestCollectorClassesFromGatherSubset().test_unknown_collector()