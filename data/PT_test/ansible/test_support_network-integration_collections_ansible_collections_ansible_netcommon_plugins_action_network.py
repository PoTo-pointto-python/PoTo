...
def test_ActionModule__handle_backup_option():
    ret = ActionModule()._handle_backup_option()

def test_ActionModule__get_working_path():
    ret = ActionModule()._get_working_path()

def test_ActionModule__handle_src_option():
    ret = ActionModule()._handle_src_option()
