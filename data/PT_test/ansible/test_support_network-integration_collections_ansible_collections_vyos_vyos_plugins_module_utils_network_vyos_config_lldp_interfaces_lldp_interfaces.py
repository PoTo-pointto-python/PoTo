...
from ansible_collections.vyos.vyos.plugins.module_utils.network.vyos.utils.utils import search_obj_in_list, search_dict_tv_in_list, key_value_in_dict, is_dict_element_present
...
def test_Lldp_interfaces_get_lldp_interfaces_facts():
    ret = Lldp_interfaces().get_lldp_interfaces_facts()

def test_Lldp_interfaces_execute_module():
    ret = Lldp_interfaces().execute_module()

def test_Lldp_interfaces_set_config():
    ret = Lldp_interfaces().set_config()

def test_Lldp_interfaces_set_state():
    ret = Lldp_interfaces().set_state()

def test_Lldp_interfaces__state_replaced():
    ret = Lldp_interfaces()._state_replaced()

def test_Lldp_interfaces__state_overridden():
    ret = Lldp_interfaces()._state_overridden()

def test_Lldp_interfaces__state_merged():
    ret = Lldp_interfaces()._state_merged()

def test_Lldp_interfaces__state_deleted():
    ret = Lldp_interfaces()._state_deleted()

def test_Lldp_interfaces__render_updates():
    ret = Lldp_interfaces()._render_updates()

def test_Lldp_interfaces__render_set_commands():
    ret = Lldp_interfaces()._render_set_commands()

def test_Lldp_interfaces__configure_status():
    ret = Lldp_interfaces()._configure_status()

def test_Lldp_interfaces__add_location():
    ret = Lldp_interfaces()._add_location()

def test_Lldp_interfaces__update_location():
    ret = Lldp_interfaces()._update_location()

def test_Lldp_interfaces__add_civic_address():
    ret = Lldp_interfaces()._add_civic_address()

def test_Lldp_interfaces__update_civic_address():
    ret = Lldp_interfaces()._update_civic_address()

def test_Lldp_interfaces__compute_command():
    ret = Lldp_interfaces()._compute_command()