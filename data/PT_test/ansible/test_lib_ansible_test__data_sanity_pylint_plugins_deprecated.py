...
class AnsibleDeprecatedChecker(BaseChecker):
    ...
    def visit_call(self, node):
        ...
        try:
            if node.func.attrname == 'deprecated' and 'display' in _get_expr_name(node) or (node.func.attrname == 'deprecate' and _get_expr_name(node)):
                if node.keywords:
...
def test_AnsibleDeprecatedChecker_set_option():
    ret = AnsibleDeprecatedChecker().set_option()

def test_AnsibleDeprecatedChecker__check_date():
    ret = AnsibleDeprecatedChecker()._check_date()

def test_AnsibleDeprecatedChecker__check_version():
    ret = AnsibleDeprecatedChecker()._check_version()

def test_AnsibleDeprecatedChecker_visit_call():
    ret = AnsibleDeprecatedChecker().visit_call()