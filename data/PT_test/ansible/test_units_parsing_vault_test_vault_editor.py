...
class TestVaultEditor(unittest.TestCase):
    ...
    def test_edit_file_helper_call_exception(self, mock_sp_call):
        ...
        ve = self._vault_editor()
        self.assertRaisesRegexp(errors.AnsibleError, error_txt, ve._edit_file_helper, src_file_path, self.vault_secret)
    ...
    def test_rekey_file_no_new_password(self):
        ...
        ve = self._vault_editor()
        ve.encrypt_file(src_file_path, self.vault_secret)
        self.assertRaisesRegexp(errors.AnsibleError, 'The value for the new_password to rekey', ve.rekey_file, src_file_path, None)
    ...
    def test_rekey_file_not_encrypted(self):
        ...
        ve = self._vault_editor()
        new_password = 'password2:electricbugaloo'
        self.assertRaisesRegexp(errors.AnsibleError, 'input is not vault encrypted data', ve.rekey_file, src_file_path, new_password)
    ...
    def test_plaintext_not_encrypted(self):
        ...
        src_file_path = self._create_file(self._test_dir, 'src_file', content=src_file_contents)
        ve = self._vault_editor()
        self.assertRaisesRegexp(errors.AnsibleError, 'input is not vault encrypted data', ve.plaintext, src_file_path)
    ...
    def test_edit_file_not_encrypted(self, mock_sp_call):
        ...
        mock_sp_call.side_effect = faux_editor
        ve = self._vault_editor()
        self.assertRaisesRegexp(errors.AnsibleError, 'input is not vault encrypted data', ve.edit_file, src_file_path)
    ...
    def test_create_file_exists(self):
        ...
        src_file_path = self._create_file(self._test_dir, 'src_file', content=src_contents)
        ve = self._vault_editor()
        self.assertRaisesRegexp(errors.AnsibleError, 'please use .edit. instead', ve.create_file, src_file_path, self.vault_secret)
...
def test_TestVaultEditor_setUp():
    ret = TestVaultEditor().setUp()

def test_TestVaultEditor_vault_secret():
    ret = TestVaultEditor().vault_secret()

def test_TestVaultEditor_tearDown():
    ret = TestVaultEditor().tearDown()

def test_TestVaultEditor__secrets():
    ret = TestVaultEditor()._secrets()

def test_TestVaultEditor_test_methods_exist():
    ret = TestVaultEditor().test_methods_exist()

def test_TestVaultEditor__create_test_dir():
    ret = TestVaultEditor()._create_test_dir()

def test_TestVaultEditor__create_file():
    ret = TestVaultEditor()._create_file()

def test_TestVaultEditor__vault_editor():
    ret = TestVaultEditor()._vault_editor()

def test_TestVaultEditor_test_edit_file_helper_empty_target():
    ret = TestVaultEditor().test_edit_file_helper_empty_target()

def test_TestVaultEditor_test_edit_file_helper_call_exception():
    ret = TestVaultEditor().test_edit_file_helper_call_exception()

def test_TestVaultEditor_test_edit_file_helper_symlink_target():
    ret = TestVaultEditor().test_edit_file_helper_symlink_target()

def test_TestVaultEditor__faux_editor():
    ret = TestVaultEditor()._faux_editor()

def test_TestVaultEditor__faux_command():
    ret = TestVaultEditor()._faux_command()

def test_TestVaultEditor_faux_editor():
    ret = TestVaultEditor().faux_editor()

def test_TestVaultEditor_test_edit_file_helper_no_change():
    ret = TestVaultEditor().test_edit_file_helper_no_change()

def test_TestVaultEditor__assert_file_is_encrypted():
    ret = TestVaultEditor()._assert_file_is_encrypted()

def test_TestVaultEditor__assert_file_is_link():
    ret = TestVaultEditor()._assert_file_is_link()

def test_TestVaultEditor_test_rekey_file():
    ret = TestVaultEditor().test_rekey_file()

def test_TestVaultEditor_test_rekey_file_no_new_password():
    ret = TestVaultEditor().test_rekey_file_no_new_password()

def test_TestVaultEditor_test_rekey_file_not_encrypted():
    ret = TestVaultEditor().test_rekey_file_not_encrypted()

def test_TestVaultEditor_test_plaintext():
    ret = TestVaultEditor().test_plaintext()

def test_TestVaultEditor_test_plaintext_not_encrypted():
    ret = TestVaultEditor().test_plaintext_not_encrypted()

def test_TestVaultEditor_test_encrypt_file():
    ret = TestVaultEditor().test_encrypt_file()

def test_TestVaultEditor_test_encrypt_file_symlink():
    ret = TestVaultEditor().test_encrypt_file_symlink()

def test_TestVaultEditor_faux_editor():
    ret = TestVaultEditor().faux_editor()

def test_TestVaultEditor_test_edit_file_no_vault_id():
    ret = TestVaultEditor().test_edit_file_no_vault_id()

def test_TestVaultEditor_faux_editor():
    ret = TestVaultEditor().faux_editor()

def test_TestVaultEditor_test_edit_file_with_vault_id():
    ret = TestVaultEditor().test_edit_file_with_vault_id()

def test_TestVaultEditor_faux_editor():
    ret = TestVaultEditor().faux_editor()

def test_TestVaultEditor_test_edit_file_symlink():
    ret = TestVaultEditor().test_edit_file_symlink()

def test_TestVaultEditor_faux_editor():
    ret = TestVaultEditor().faux_editor()

def test_TestVaultEditor_test_edit_file_not_encrypted():
    ret = TestVaultEditor().test_edit_file_not_encrypted()

def test_TestVaultEditor_test_create_file_exists():
    ret = TestVaultEditor().test_create_file_exists()

def test_TestVaultEditor_test_decrypt_file_exception():
    ret = TestVaultEditor().test_decrypt_file_exception()

def test_TestVaultEditor_sc_side_effect():
    ret = TestVaultEditor().sc_side_effect()

def test_TestVaultEditor_test_create_file():
    ret = TestVaultEditor().test_create_file()

def test_TestVaultEditor_test_decrypt_1_1():
    ret = TestVaultEditor().test_decrypt_1_1()

def test_TestVaultEditor_test_real_path_dash():
    ret = TestVaultEditor().test_real_path_dash()

def test_TestVaultEditor_test_real_path_dev_null():
    ret = TestVaultEditor().test_real_path_dev_null()

def test_TestVaultEditor_test_real_path_symlink():
    ret = TestVaultEditor().test_real_path_symlink()

def test_TestVaultEditorPyCrypto_setUp():
    ret = TestVaultEditorPyCrypto().setUp()

def test_TestVaultEditorPyCrypto_tearDown():
    ret = TestVaultEditorPyCrypto().tearDown()