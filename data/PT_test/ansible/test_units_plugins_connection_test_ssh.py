...
class TestSSHConnectionRun(object):
    ...
    def test_no_escalation(self):
        ...
        self.mock_selector.select.side_effect = [[(SelectorKey(self.mock_popen_res.stdout, 1001, [EVENT_READ], None), EVENT_READ)], [(SelectorKey(self.mock_popen_res.stdout, 1001, [EVENT_READ], None), EVENT_READ)], [(SelectorKey(self.mock_popen_res.stderr, 1002, [EVENT_READ], None), EVENT_READ)], []]
...
class TestSSHConnectionRetries(object):
    ...
    def test_incorrect_password(self, monkeypatch):
        ...
        self.mock_selector.select.side_effect = [[(SelectorKey(self.mock_popen_res.stdout, 1001, [EVENT_READ], None), EVENT_READ)], [(SelectorKey(self.mock_popen_res.stderr, 1002, [EVENT_READ], None), EVENT_READ)], []]
        self.mock_selector.get_map.side_effect = lambda : True
        ...
        assert exception_info.value.message == 'Invalid/incorrect username/password. Skipping remaining 5 retries to prevent account lockout: Permission denied, please try again.'
    ...
    def test_multiple_failures(self, monkeypatch):
        ...
        self.mock_selector.select.side_effect = [[(SelectorKey(self.mock_popen_res.stdout, 1001, [EVENT_READ], None), EVENT_READ)], [(SelectorKey(self.mock_popen_res.stderr, 1002, [EVENT_READ], None), EVENT_READ)], []] * 10
        self.mock_selector.get_map.side_effect = lambda : True
        self.conn._build_command = MagicMock()
        self.conn._build_command.return_value = 'ssh'
        self.conn.get_option = MagicMock()
...
def test_TestConnectionBaseClass_test_plugins_connection_ssh_module():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh_module()

def test_TestConnectionBaseClass_test_plugins_connection_ssh_basic():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh_basic()

def test_TestConnectionBaseClass_test_plugins_connection_ssh__build_command():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh__build_command()

def test_TestConnectionBaseClass_test_plugins_connection_ssh_exec_command():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh_exec_command()

def test_TestConnectionBaseClass__check_password_prompt():
    ret = TestConnectionBaseClass()._check_password_prompt()

def test_TestConnectionBaseClass__check_become_success():
    ret = TestConnectionBaseClass()._check_become_success()

def test_TestConnectionBaseClass__check_incorrect_password():
    ret = TestConnectionBaseClass()._check_incorrect_password()

def test_TestConnectionBaseClass__check_missing_password():
    ret = TestConnectionBaseClass()._check_missing_password()

def test_TestConnectionBaseClass_get_option():
    ret = TestConnectionBaseClass().get_option()

def test_TestConnectionBaseClass_test_plugins_connection_ssh__examine_output():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh__examine_output()

def test_TestConnectionBaseClass_test_plugins_connection_ssh_put_file():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh_put_file()

def test_TestConnectionBaseClass_test_plugins_connection_ssh_fetch_file():
    ret = TestConnectionBaseClass().test_plugins_connection_ssh_fetch_file()

def test_MockSelector__register():
    ret = MockSelector()._register()

def test_MockSelector__unregister():
    ret = MockSelector()._unregister()

def test_MockSelector__get_map():
    ret = MockSelector()._get_map()

def test_TestSSHConnectionRun_test_no_escalation():
    ret = TestSSHConnectionRun().test_no_escalation()

def test_TestSSHConnectionRun_test_with_password():
    ret = TestSSHConnectionRun().test_with_password()

def test_TestSSHConnectionRun__password_with_prompt_examine_output():
    ret = TestSSHConnectionRun()._password_with_prompt_examine_output()

def test_TestSSHConnectionRun_test_password_with_prompt():
    ret = TestSSHConnectionRun().test_password_with_prompt()

def test_TestSSHConnectionRun_test_password_with_become():
    ret = TestSSHConnectionRun().test_password_with_become()

def test_TestSSHConnectionRun_test_pasword_without_data():
    ret = TestSSHConnectionRun().test_pasword_without_data()

def test_TestSSHConnectionRetries_test_incorrect_password():
    ret = TestSSHConnectionRetries().test_incorrect_password()

def test_TestSSHConnectionRetries_test_retry_then_success():
    ret = TestSSHConnectionRetries().test_retry_then_success()

def test_TestSSHConnectionRetries_test_multiple_failures():
    ret = TestSSHConnectionRetries().test_multiple_failures()

def test_TestSSHConnectionRetries_test_abitrary_exceptions():
    ret = TestSSHConnectionRetries().test_abitrary_exceptions()

def test_TestSSHConnectionRetries_test_put_file_retries():
    ret = TestSSHConnectionRetries().test_put_file_retries()

def test_TestSSHConnectionRetries_test_fetch_file_retries():
    ret = TestSSHConnectionRetries().test_fetch_file_retries()