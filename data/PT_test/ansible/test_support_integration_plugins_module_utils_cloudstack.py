...
class AnsibleCloudStack:
    ...
    def __init__(self, module):
        ...
        self.common_returns = {'id': 'id', 'name': 'name', 'created': 'created', 'zonename': 'zone', 'state': 'state', 'project': 'project', 'account': 'account', 'domain': 'domain', 'displaytext': 'display_text', 'displayname': 'display_name', 'description': 'description'}
        self.returns = {}
        self.returns_to_int = {}
    ...
    def get_api_config(self):
        ...
        try:
            ...
            config = {}
        api_config = {'endpoint': self.module.params.get('api_url') or config.get('endpoint'), 'key': self.module.params.get('api_key') or config.get('key'), 'secret': self.module.params.get('api_secret') or config.get('secret'), 'timeout': self.module.params.get('api_timeout') or config.get('timeout') or 10, 'method': self.module.params.get('api_http_method') or config.get('method') or 'get'}
        self.result.update({'api_region': api_region, 'api_url': api_config['endpoint'], 'api_key': api_config['key'], 'api_timeout': int(api_config['timeout']), 'api_http_method': api_config['method']})
...
def test_AnsibleCloudStack_cs():
    ret = AnsibleCloudStack().cs()

def test_AnsibleCloudStack_get_api_config():
    ret = AnsibleCloudStack().get_api_config()

def test_AnsibleCloudStack_fail_json():
    ret = AnsibleCloudStack().fail_json()

def test_AnsibleCloudStack_get_or_fallback():
    ret = AnsibleCloudStack().get_or_fallback()

def test_AnsibleCloudStack_has_changed():
    ret = AnsibleCloudStack().has_changed()

def test_AnsibleCloudStack__get_by_key():
    ret = AnsibleCloudStack()._get_by_key()

def test_AnsibleCloudStack_query_api():
    ret = AnsibleCloudStack().query_api()

def test_AnsibleCloudStack_get_network_acl():
    ret = AnsibleCloudStack().get_network_acl()

def test_AnsibleCloudStack_get_vpc():
    ret = AnsibleCloudStack().get_vpc()

def test_AnsibleCloudStack_is_vpc_network():
    ret = AnsibleCloudStack().is_vpc_network()

def test_AnsibleCloudStack_get_physical_network():
    ret = AnsibleCloudStack().get_physical_network()

def test_AnsibleCloudStack_get_network():
    ret = AnsibleCloudStack().get_network()

def test_AnsibleCloudStack_get_project():
    ret = AnsibleCloudStack().get_project()

def test_AnsibleCloudStack_get_ip_address():
    ret = AnsibleCloudStack().get_ip_address()

def test_AnsibleCloudStack_get_vm_guest_ip():
    ret = AnsibleCloudStack().get_vm_guest_ip()

def test_AnsibleCloudStack_get_vm_default_nic():
    ret = AnsibleCloudStack().get_vm_default_nic()

def test_AnsibleCloudStack_get_vm():
    ret = AnsibleCloudStack().get_vm()

def test_AnsibleCloudStack_get_disk_offering():
    ret = AnsibleCloudStack().get_disk_offering()

def test_AnsibleCloudStack_get_zone():
    ret = AnsibleCloudStack().get_zone()

def test_AnsibleCloudStack_get_os_type():
    ret = AnsibleCloudStack().get_os_type()

def test_AnsibleCloudStack_get_hypervisor():
    ret = AnsibleCloudStack().get_hypervisor()

def test_AnsibleCloudStack_get_account():
    ret = AnsibleCloudStack().get_account()

def test_AnsibleCloudStack_get_domain():
    ret = AnsibleCloudStack().get_domain()

def test_AnsibleCloudStack_query_tags():
    ret = AnsibleCloudStack().query_tags()

def test_AnsibleCloudStack_get_tags():
    ret = AnsibleCloudStack().get_tags()

def test_AnsibleCloudStack__process_tags():
    ret = AnsibleCloudStack()._process_tags()

def test_AnsibleCloudStack__tags_that_should_exist_or_be_updated():
    ret = AnsibleCloudStack()._tags_that_should_exist_or_be_updated()

def test_AnsibleCloudStack__tags_that_should_not_exist():
    ret = AnsibleCloudStack()._tags_that_should_not_exist()

def test_AnsibleCloudStack_ensure_tags():
    ret = AnsibleCloudStack().ensure_tags()

def test_AnsibleCloudStack_get_capabilities():
    ret = AnsibleCloudStack().get_capabilities()

def test_AnsibleCloudStack_poll_job():
    ret = AnsibleCloudStack().poll_job()

def test_AnsibleCloudStack_update_result():
    ret = AnsibleCloudStack().update_result()

def test_AnsibleCloudStack_get_result():
    ret = AnsibleCloudStack().get_result()

def test_AnsibleCloudStack_get_result_and_facts():
    ret = AnsibleCloudStack().get_result_and_facts()