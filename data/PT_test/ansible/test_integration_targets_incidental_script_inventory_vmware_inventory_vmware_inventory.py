...
def test_VMWareInventory__empty_inventory():
    ret = VMWareInventory()._empty_inventory()

def test_VMWareInventory_debugl():
    ret = VMWareInventory().debugl()

def test_VMWareInventory_show():
    ret = VMWareInventory().show()

def test_VMWareInventory_is_cache_valid():
    ret = VMWareInventory().is_cache_valid()

def test_VMWareInventory_do_api_calls_update_cache():
    ret = VMWareInventory().do_api_calls_update_cache()

def test_VMWareInventory_write_to_cache():
    ret = VMWareInventory().write_to_cache()

def test_VMWareInventory_get_inventory_from_cache():
    ret = VMWareInventory().get_inventory_from_cache()

def test_VMWareInventory_read_settings():
    ret = VMWareInventory().read_settings()

def test_VMWareInventory_parse_cli_args():
    ret = VMWareInventory().parse_cli_args()

def test_VMWareInventory_get_instances():
    ret = VMWareInventory().get_instances()

def test_VMWareInventory__get_instances():
    ret = VMWareInventory()._get_instances()

def test_VMWareInventory_instances_to_inventory():
    ret = VMWareInventory().instances_to_inventory()

def test_VMWareInventory_create_template_mapping():
    ret = VMWareInventory().create_template_mapping()

def test_VMWareInventory_facts_from_proplist():
    ret = VMWareInventory().facts_from_proplist()

def test_VMWareInventory_facts_from_vobj():
    ret = VMWareInventory().facts_from_vobj()

def test_VMWareInventory__process_object_types():
    ret = VMWareInventory()._process_object_types()

def test_VMWareInventory_get_host_info():
    ret = VMWareInventory().get_host_info()