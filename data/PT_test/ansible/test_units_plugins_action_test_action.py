...
def _action_base():
    ...
    action_base = DerivedActionBase(task=None, connection=mock_connection, play_context=play_context, loader=fake_loader, templar=None, shared_loader_obj=mock_shared_loader_obj)
    return action_base
...
class TestActionBase(unittest.TestCase):
    ...
    def test_action_base__configure_module(self):
        ...
        with patch.object(builtins, 'open', mock_open(read_data=to_bytes(python_module_replacers.strip(), encoding='utf-8'))):
            with patch.object(os, 'rename'):
                ...
                (style, shebang, data, path) = action_base._configure_module(mock_task.action, mock_task.args, task_vars=dict(ansible_python_interpreter='/usr/bin/python'))
    ...
    def test_action_base__compute_environment_string(self):
        ...
        action_base = DerivedActionBase(task=mock_task, connection=mock_connection, play_context=play_context, loader=fake_loader, templar=templar, shared_loader_obj=None)
    ...
    def test_action_base__fixup_perms2(self):
        ...
        def assertThrowRegex(regex, execute=False):
            self.assertRaisesRegexp(AnsibleError, regex, action_base._fixup_perms2, remote_paths, remote_user=remote_user, execute=execute)
        ...
        assertThrowRegex('Failed to set file mode on remote temporary file', execute=True)
        ...
        action_base._remote_chmod.return_value = {'rc': 0, 'stdout': '', 'stderr': ''}
        assertSuccess()
    ...
    def test__remote_expand_user_relative_pathing(self):
        ...
        self.assertEqual(cm.exception.message, "'bar' returned an invalid relative home directory path containing '..'")
...
class TestActionBaseParseReturnedData(unittest.TestCase):
    ...
    def test_fail_no_json(self):
        ...
        stdout = 'foo\nbar\n'
        err = 'oopsy'
        returned_data = {'rc': rc, 'stdout': stdout, 'stdout_lines': stdout.splitlines(), 'stderr': err}
...
def test_DerivedActionBase_run():
    ret = DerivedActionBase().run()

def test_TestActionBase_test_action_base_run():
    ret = TestActionBase().test_action_base_run()

def test_TestActionBase_mock_find_plugin_with_context():
    ret = TestActionBase().mock_find_plugin_with_context()

def test_TestActionBase_test_action_base__configure_module():
    ret = TestActionBase().test_action_base__configure_module()

def test_TestActionBase_env_prefix():
    ret = TestActionBase().env_prefix()

def test_TestActionBase_test_action_base__compute_environment_string():
    ret = TestActionBase().test_action_base__compute_environment_string()

def test_TestActionBase_test_action_base__early_needs_tmp_path():
    ret = TestActionBase().test_action_base__early_needs_tmp_path()

def test_TestActionBase_get_shell_opt():
    ret = TestActionBase().get_shell_opt()

def test_TestActionBase_test_action_base__make_tmp_path():
    ret = TestActionBase().test_action_base__make_tmp_path()

def test_TestActionBase_runWithNoExpectation():
    ret = TestActionBase().runWithNoExpectation()

def test_TestActionBase_assertSuccess():
    ret = TestActionBase().assertSuccess()

def test_TestActionBase_assertThrowRegex():
    ret = TestActionBase().assertThrowRegex()

def test_TestActionBase__helper():
    ret = TestActionBase()._helper()

def test_TestActionBase_get_shell_option_for_arg():
    ret = TestActionBase().get_shell_option_for_arg()

def test_TestActionBase_test_action_base__fixup_perms2():
    ret = TestActionBase().test_action_base__fixup_perms2()

def test_TestActionBase_test_action_base__remove_tmp_path():
    ret = TestActionBase().test_action_base__remove_tmp_path()

def test_TestActionBase_test_action_base__transfer_data():
    ret = TestActionBase().test_action_base__transfer_data()

def test_TestActionBase_test_action_base__execute_remote_stat():
    ret = TestActionBase().test_action_base__execute_remote_stat()

def test_TestActionBase_build_module_command():
    ret = TestActionBase().build_module_command()

def test_TestActionBase_get_option():
    ret = TestActionBase().get_option()

def test_TestActionBase_test_action_base__execute_module():
    ret = TestActionBase().test_action_base__execute_module()

def test_TestActionBase_test_action_base_sudo_only_if_user_differs():
    ret = TestActionBase().test_action_base_sudo_only_if_user_differs()

def test_TestActionBase_test__remote_expand_user_relative_pathing():
    ret = TestActionBase().test__remote_expand_user_relative_pathing()

def test_TestActionBaseCleanReturnedData_fake_all():
    ret = TestActionBaseCleanReturnedData().fake_all()

def test_TestActionBaseCleanReturnedData_test():
    ret = TestActionBaseCleanReturnedData().test()

def test_TestActionBaseParseReturnedData_test_fail_no_json():
    ret = TestActionBaseParseReturnedData().test_fail_no_json()

def test_TestActionBaseParseReturnedData_test_json_empty():
    ret = TestActionBaseParseReturnedData().test_json_empty()

def test_TestActionBaseParseReturnedData_test_json_facts():
    ret = TestActionBaseParseReturnedData().test_json_facts()

def test_TestActionBaseParseReturnedData_test_json_facts_add_host():
    ret = TestActionBaseParseReturnedData().test_json_facts_add_host()