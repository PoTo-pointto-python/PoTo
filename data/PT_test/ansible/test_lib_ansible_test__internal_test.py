...
from .util import display, get_ansible_version
from .util_common import write_text_test_results, write_json_test_results, ResultType
...
class TestResult:
    ...
    def save_junit(self, args, test_case, properties=None):
        ...
        :rtype: str | None
        """
        test_suites = [self.junit.TestSuite(name='ansible-test', test_cases=[test_case], timestamp=datetime.datetime.utcnow().replace(microsecond=0).isoformat(), properties=properties)]
        try:
...
def test_TestResult_write():
    ret = TestResult().write()

def test_TestResult_write_console():
    ret = TestResult().write_console()

def test_TestResult_write_lint():
    ret = TestResult().write_lint()

def test_TestResult_write_bot():
    ret = TestResult().write_bot()

def test_TestResult_write_junit():
    ret = TestResult().write_junit()

def test_TestResult_create_result_name():
    ret = TestResult().create_result_name()

def test_TestResult_save_junit():
    ret = TestResult().save_junit()

def test_TestTimeout_write():
    ret = TestTimeout().write()

def test_TestSuccess_write_junit():
    ret = TestSuccess().write_junit()

def test_TestSkipped_write_console():
    ret = TestSkipped().write_console()

def test_TestSkipped_write_junit():
    ret = TestSkipped().write_junit()

def test_TestFailure_write():
    ret = TestFailure().write()

def test_TestFailure_write_console():
    ret = TestFailure().write_console()

def test_TestFailure_write_lint():
    ret = TestFailure().write_lint()

def test_TestFailure_write_junit():
    ret = TestFailure().write_junit()

def test_TestFailure_write_bot():
    ret = TestFailure().write_bot()

def test_TestFailure_populate_confidence():
    ret = TestFailure().populate_confidence()

def test_TestFailure_format_command():
    ret = TestFailure().format_command()

def test_TestFailure_find_docs():
    ret = TestFailure().find_docs()

def test_TestFailure_format_title():
    ret = TestFailure().format_title()

def test_TestFailure_format_block():
    ret = TestFailure().format_block()

def test_TestMessage_path():
    ret = TestMessage().path()

def test_TestMessage_line():
    ret = TestMessage().line()

def test_TestMessage_column():
    ret = TestMessage().column()

def test_TestMessage_level():
    ret = TestMessage().level()

def test_TestMessage_code():
    ret = TestMessage().code()

def test_TestMessage_message():
    ret = TestMessage().message()

def test_TestMessage_tuple():
    ret = TestMessage().tuple()

def test_TestMessage___lt__():
    ret = TestMessage().__lt__()

def test_TestMessage___le__():
    ret = TestMessage().__le__()

def test_TestMessage___eq__():
    ret = TestMessage().__eq__()

def test_TestMessage___ne__():
    ret = TestMessage().__ne__()

def test_TestMessage___gt__():
    ret = TestMessage().__gt__()

def test_TestMessage___ge__():
    ret = TestMessage().__ge__()

def test_TestMessage___hash__():
    ret = TestMessage().__hash__()

def test_TestMessage___str__():
    ret = TestMessage().__str__()

def test_TestMessage_format():
    ret = TestMessage().format()