...
def test_TestIptables_setUp():
    ret = TestIptables().setUp()

def test_TestIptables_test_without_required_parameters():
    ret = TestIptables().test_without_required_parameters()

def test_TestIptables_test_flush_table_without_chain():
    ret = TestIptables().test_flush_table_without_chain()

def test_TestIptables_test_flush_table_check_true():
    ret = TestIptables().test_flush_table_check_true()

def test_TestIptables_test_policy_table():
    ret = TestIptables().test_policy_table()

def test_TestIptables_test_policy_table_no_change():
    ret = TestIptables().test_policy_table_no_change()

def test_TestIptables_test_policy_table_changed_false():
    ret = TestIptables().test_policy_table_changed_false()

def test_TestIptables_test_insert_rule_change_false():
    ret = TestIptables().test_insert_rule_change_false()

def test_TestIptables_test_insert_rule():
    ret = TestIptables().test_insert_rule()

def test_TestIptables_test_append_rule_check_mode():
    ret = TestIptables().test_append_rule_check_mode()

def test_TestIptables_test_append_rule():
    ret = TestIptables().test_append_rule()

def test_TestIptables_test_remove_rule():
    ret = TestIptables().test_remove_rule()

def test_TestIptables_test_remove_rule_check_mode():
    ret = TestIptables().test_remove_rule_check_mode()

def test_TestIptables_test_insert_with_reject():
    ret = TestIptables().test_insert_with_reject()

def test_TestIptables_test_insert_jump_reject_with_reject():
    ret = TestIptables().test_insert_jump_reject_with_reject()

def test_TestIptables_test_jump_tee_gateway_negative():
    ret = TestIptables().test_jump_tee_gateway_negative()

def test_TestIptables_test_jump_tee_gateway():
    ret = TestIptables().test_jump_tee_gateway()

def test_TestIptables_test_tcp_flags():
    ret = TestIptables().test_tcp_flags()

def test_TestIptables_test_log_level():
    ret = TestIptables().test_log_level()

def test_TestIptables_test_iprange():
    ret = TestIptables().test_iprange()

def test_TestIptables_test_insert_rule_with_wait():
    ret = TestIptables().test_insert_rule_with_wait()