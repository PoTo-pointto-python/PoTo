...
def test_Lldp_globalFacts_populate_facts():
    ret = Lldp_globalFacts().populate_facts()

def test_Lldp_globalFacts_render_config():
    ret = Lldp_globalFacts().render_config()

def test_Lldp_globalFacts_parse_protocols():
    ret = Lldp_globalFacts().parse_protocols()

def test_Lldp_globalFacts_parse_attribs():
    ret = Lldp_globalFacts().parse_attribs()