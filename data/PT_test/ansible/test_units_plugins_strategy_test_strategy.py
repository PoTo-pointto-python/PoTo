...
class TestStrategyBase(unittest.TestCase):
    ...
    def test_strategy_base_queue_task(self, mock_worker):
        ...
        tqm = TaskQueueManager(inventory=mock_inventory, variable_manager=mock_var_manager, loader=fake_loader, passwords=None, forks=3)
    ...
    def test_strategy_base_process_pending_results(self):
        ...
        mock_queued_task_cache = {(mock_host.name, mock_task._uuid): {'task': mock_task, 'host': mock_host, 'task_vars': {}, 'play_context': {}}}
    ...
    def test_strategy_base_load_included_file(self):
        fake_loader = DictDataLoader({'test.yml': "\n            - debug: msg='foo'\n            ", 'bad.yml': '\n            '})
        queue_items = []
    ...
    def test_strategy_base_run_handlers(self, mock_worker):
        ...
        mock_iterator._play = mock_play
        fake_loader = DictDataLoader()
        tqm = TaskQueueManager(inventory=mock_inventory, variable_manager=mock_var_mgr, loader=fake_loader, passwords=None, forks=5)
        tqm._initialize_processes(3)
        tqm.hostvars = dict()
        try:
            strategy_base = StrategyBase(tqm=tqm)
            ...
            strategy_base._queued_task_cache[mock_host.name, mock_handler_task._uuid] = {'task': mock_handler_task, 'host': mock_host, 'task_vars': {}, 'play_context': mock_play_context}
...
def test_TestStrategyBase__queue_empty():
    ret = TestStrategyBase()._queue_empty()

def test_TestStrategyBase__queue_get():
    ret = TestStrategyBase()._queue_get()

def test_TestStrategyBase__queue_put():
    ret = TestStrategyBase()._queue_put()

def test_TestStrategyBase_test_strategy_base_init():
    ret = TestStrategyBase().test_strategy_base_init()
...
def test_TestStrategyBase_test_strategy_base_run():
    ret = TestStrategyBase().test_strategy_base_run()
...
def test_TestStrategyBase_test_strategy_base_get_hosts():
    ret = TestStrategyBase().test_strategy_base_get_hosts()

def test_TestStrategyBase_fake_run():
    ret = TestStrategyBase().fake_run()

def test_TestStrategyBase_test_strategy_base_queue_task():
    ret = TestStrategyBase().test_strategy_base_queue_task()
...
def test_TestStrategyBase__get_host():
    ret = TestStrategyBase()._get_host()

def test_TestStrategyBase__get_group():
    ret = TestStrategyBase()._get_group()

def test_TestStrategyBase__has_dead_workers():
    ret = TestStrategyBase()._has_dead_workers()

def test_TestStrategyBase_test_strategy_base_process_pending_results():
    ret = TestStrategyBase().test_strategy_base_process_pending_results()
...
def test_TestStrategyBase_test_strategy_base_load_included_file():
    ret = TestStrategyBase().test_strategy_base_load_included_file()

def test_TestStrategyBase_fake_run():
    ret = TestStrategyBase().fake_run()

def test_TestStrategyBase_test_strategy_base_run_handlers():
    ret = TestStrategyBase().test_strategy_base_run_handlers()