...
expected_ini = {'CONFIG_FILE': Setting(name='CONFIG_FILE', value=cfg_file, origin='', type='string'), 'config_entry': Setting(name='config_entry', value=u'fromini', origin=cfg_file, type='string'), 'config_entry_bool': Setting(name='config_entry_bool', value=False, origin=cfg_file, type='bool'), 'config_entry_list': Setting(name='config_entry_list', value=['fromini'], origin=cfg_file, type='list'), 'config_entry_deprecated': Setting(name='config_entry_deprecated', value=u'fromini', origin=cfg_file, type='string'), 'config_entry_multi': Setting(name='config_entry_multi', value=u'morefromini', origin=cfg_file, type='string'), 'config_entry_multi_deprecated': Setting(name='config_entry_multi_deprecated', value=u'morefromini', origin=cfg_file, type='string'), 'config_entry_multi_deprecated_source': Setting(name='config_entry_multi_deprecated_source', value=u'morefromini', origin=cfg_file, type='string')}
ensure_test_data = [('a,b', 'list', list), (['a', 'b'], 'list', list), ('y', 'bool', bool), ('yes', 'bool', bool), ('on', 'bool', bool), ('1', 'bool', bool), ('true', 'bool', bool), ('t', 'bool', bool), (1, 'bool', bool), (1.0, 'bool', bool), (True, 'bool', bool), ('n', 'bool', bool), ('no', 'bool', bool), ('off', 'bool', bool), ('0', 'bool', bool), ('false', 'bool', bool), ('f', 'bool', bool), (0, 'bool', bool), (0.0, 'bool', bool), (False, 'bool', bool), ('10', 'int', integer_types), (20, 'int', integer_types), ('0.10', 'float', float), (0.2, 'float', float), ('/tmp/test.yml', 'pathspec', list), ('/tmp/test.yml,/home/test2.yml', 'pathlist', list), ('a', 'str', string_types), ('a', 'string', string_types), ('Café', 'string', string_types), ('', 'string', string_types), ('None', 'none', type(None))]
...
class TestConfigManager:
    ...
    def test_ensure_type(self, value, expected_type, python_type):
        (value,  expected_type,  python_type) = ensure_test_data[0]
...
def test_TestConfigManager_setup_class():
    ret = TestConfigManager().setup_class()

def test_TestConfigManager_teardown_class():
    ret = TestConfigManager().teardown_class()

def test_TestConfigManager_test_initial_load():
    ret = TestConfigManager().test_initial_load()

def test_TestConfigManager_test_ensure_type():
    ret = TestConfigManager().test_ensure_type()

def test_TestConfigManager_test_resolve_path():
    ret = TestConfigManager().test_resolve_path()

def test_TestConfigManager_test_resolve_path_cwd():
    ret = TestConfigManager().test_resolve_path_cwd()

def test_TestConfigManager_test_value_and_origin_from_ini():
    ret = TestConfigManager().test_value_and_origin_from_ini()

def test_TestConfigManager_test_value_from_ini():
    ret = TestConfigManager().test_value_from_ini()

def test_TestConfigManager_test_value_and_origin_from_alt_ini():
    ret = TestConfigManager().test_value_and_origin_from_alt_ini()

def test_TestConfigManager_test_value_from_alt_ini():
    ret = TestConfigManager().test_value_from_alt_ini()

def test_TestConfigManager_test_config_types():
    ret = TestConfigManager().test_config_types()

def test_TestConfigManager_test_config_types_negative():
    ret = TestConfigManager().test_config_types_negative()

def test_TestConfigManager_test_read_config_yaml_file():
    ret = TestConfigManager().test_read_config_yaml_file()

def test_TestConfigManager_test_read_config_yaml_file_negative():
    ret = TestConfigManager().test_read_config_yaml_file_negative()

def test_TestConfigManager_test_entry_as_vault_var():
    ret = TestConfigManager().test_entry_as_vault_var()

def test_TestConfigManager_test_ensure_type_with_vaulted_str():
    ret = TestConfigManager().test_ensure_type_with_vaulted_str()

def test_MockVault_decrypt():
    ret = MockVault().decrypt()