...
class AzureRMMariaDbDatabase(AzureRMModuleBase):
    ...
    def create_update_mariadbdatabase(self):
        ...
        try:
            response = self.mgmt_client.databases.create_or_update(resource_group_name=self.resource_group, server_name=self.server_name, database_name=self.name, parameters=self.parameters)
    ...
    def delete_mariadbdatabase(self):
        ...
        try:
            response = self.mgmt_client.databases.delete(resource_group_name=self.resource_group, server_name=self.server_name, database_name=self.name)
    ...
    def get_mariadbdatabase(self):
        ...
        found = False
        try:
            response = self.mgmt_client.databases.get(resource_group_name=self.resource_group, server_name=self.server_name, database_name=self.name)
            found = True
...
def test_AzureRMMariaDbDatabase_exec_module():
    ret = AzureRMMariaDbDatabase().exec_module()

def test_AzureRMMariaDbDatabase_create_update_mariadbdatabase():
    ret = AzureRMMariaDbDatabase().create_update_mariadbdatabase()

def test_AzureRMMariaDbDatabase_delete_mariadbdatabase():
    ret = AzureRMMariaDbDatabase().delete_mariadbdatabase()

def test_AzureRMMariaDbDatabase_get_mariadbdatabase():
    ret = AzureRMMariaDbDatabase().get_mariadbdatabase()