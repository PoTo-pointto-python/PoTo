...
def test_TestInvalidVars_test_positive_matches():
    ret = TestInvalidVars().test_positive_matches()

def test_TestInvalidVars_test_negative_matches():
    ret = TestInvalidVars().test_negative_matches()

def test_TestInvalidVars_test_get_setting():
    ret = TestInvalidVars().test_get_setting()