...
DEFAULT_IGNORE_LINES_RE = set([re.compile('Using \\d+ out of \\d+ bytes'), re.compile('Building configuration'), re.compile('Current configuration : \\d+ bytes')])
try:
...
def test_ConfigLine___str__():
    ret = ConfigLine().__str__()

def test_ConfigLine___eq__():
    ret = ConfigLine().__eq__()

def test_ConfigLine___ne__():
    ret = ConfigLine().__ne__()

def test_ConfigLine___getitem__():
    ret = ConfigLine().__getitem__()

def test_ConfigLine_line():
    ret = ConfigLine().line()

def test_ConfigLine_children():
    ret = ConfigLine().children()

def test_ConfigLine_child_objs():
    ret = ConfigLine().child_objs()

def test_ConfigLine_parents():
    ret = ConfigLine().parents()

def test_ConfigLine_path():
    ret = ConfigLine().path()

def test_ConfigLine_has_children():
    ret = ConfigLine().has_children()

def test_ConfigLine_has_parents():
    ret = ConfigLine().has_parents()

def test_ConfigLine_add_child():
    ret = ConfigLine().add_child()

def test_NetworkConfig_items():
    ret = NetworkConfig().items()

def test_NetworkConfig_config_text():
    ret = NetworkConfig().config_text()

def test_NetworkConfig_sha1():
    ret = NetworkConfig().sha1()

def test_NetworkConfig___getitem__():
    ret = NetworkConfig().__getitem__()

def test_NetworkConfig___iter__():
    ret = NetworkConfig().__iter__()

def test_NetworkConfig___str__():
    ret = NetworkConfig().__str__()

def test_NetworkConfig___len__():
    ret = NetworkConfig().__len__()

def test_NetworkConfig_load():
    ret = NetworkConfig().load()

def test_NetworkConfig_loadfp():
    ret = NetworkConfig().loadfp()

def test_NetworkConfig_parse():
    ret = NetworkConfig().parse()

def test_NetworkConfig_get_object():
    ret = NetworkConfig().get_object()

def test_NetworkConfig_get_block():
    ret = NetworkConfig().get_block()

def test_NetworkConfig_get_block_config():
    ret = NetworkConfig().get_block_config()

def test_NetworkConfig__expand_block():
    ret = NetworkConfig()._expand_block()

def test_NetworkConfig__diff_line():
    ret = NetworkConfig()._diff_line()

def test_NetworkConfig__diff_strict():
    ret = NetworkConfig()._diff_strict()

def test_NetworkConfig__diff_exact():
    ret = NetworkConfig()._diff_exact()

def test_NetworkConfig_difference():
    ret = NetworkConfig().difference()

def test_NetworkConfig_add():
    ret = NetworkConfig().add()

def test_CustomNetworkConfig_items_text():
    ret = CustomNetworkConfig().items_text()

def test_CustomNetworkConfig_expand_section():
    ret = CustomNetworkConfig().expand_section()

def test_CustomNetworkConfig_to_block():
    ret = CustomNetworkConfig().to_block()

def test_CustomNetworkConfig_get_section():
    ret = CustomNetworkConfig().get_section()

def test_CustomNetworkConfig_get_section_objects():
    ret = CustomNetworkConfig().get_section_objects()