...
def test_TestOtherFilesystem_test_module_utils_basic_ansible_module_user_and_group():
    ret = TestOtherFilesystem().test_module_utils_basic_ansible_module_user_and_group()

def test_TestOtherFilesystem__mock_ismount():
    ret = TestOtherFilesystem()._mock_ismount()

def test_TestOtherFilesystem__mock_ismount():
    ret = TestOtherFilesystem()._mock_ismount()

def test_TestOtherFilesystem_test_module_utils_basic_ansible_module_find_mount_point():
    ret = TestOtherFilesystem().test_module_utils_basic_ansible_module_find_mount_point()

def test_TestOtherFilesystem__mock_getpwnam():
    ret = TestOtherFilesystem()._mock_getpwnam()

def test_TestOtherFilesystem_test_module_utils_basic_ansible_module_set_owner_if_different():
    ret = TestOtherFilesystem().test_module_utils_basic_ansible_module_set_owner_if_different()

def test_TestOtherFilesystem__mock_getgrnam():
    ret = TestOtherFilesystem()._mock_getgrnam()

def test_TestOtherFilesystem_test_module_utils_basic_ansible_module_set_group_if_different():
    ret = TestOtherFilesystem().test_module_utils_basic_ansible_module_set_group_if_different()