...
def test_TestLSBFacts__mock_module():
    ret = TestLSBFacts()._mock_module()

def test_TestLSBFacts_test_lsb_release_bin():
    ret = TestLSBFacts().test_lsb_release_bin()

def test_TestLSBFacts_test_etc_lsb_release():
    ret = TestLSBFacts().test_etc_lsb_release()

def test_TestLSBFacts_test_etc_lsb_release_no_decimal_release():
    ret = TestLSBFacts().test_etc_lsb_release_no_decimal_release()