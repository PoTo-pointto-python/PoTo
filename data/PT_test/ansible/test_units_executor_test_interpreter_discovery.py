...
def test_discovery_interpreter_linux_auto_legacy():
    ...
    assert u'Distribution Ubuntu 16.04 on host host-fóöbär should use /usr/bin/python3, but is using /usr/bin/python for backward compatibility' in mock_action.method_calls[2][1][0]['msg']
