...
from ansible.module_utils.docker.common import AnsibleDockerClient, LooseVersion
...
def test_AnsibleDockerSwarmClient_get_swarm_node_id():
    ret = AnsibleDockerSwarmClient().get_swarm_node_id()

def test_AnsibleDockerSwarmClient_check_if_swarm_node():
    ret = AnsibleDockerSwarmClient().check_if_swarm_node()

def test_AnsibleDockerSwarmClient_check_if_swarm_manager():
    ret = AnsibleDockerSwarmClient().check_if_swarm_manager()

def test_AnsibleDockerSwarmClient_fail_task_if_not_swarm_manager():
    ret = AnsibleDockerSwarmClient().fail_task_if_not_swarm_manager()

def test_AnsibleDockerSwarmClient_check_if_swarm_worker():
    ret = AnsibleDockerSwarmClient().check_if_swarm_worker()

def test_AnsibleDockerSwarmClient_check_if_swarm_node_is_down():
    ret = AnsibleDockerSwarmClient().check_if_swarm_node_is_down()

def test_AnsibleDockerSwarmClient_get_node_inspect():
    ret = AnsibleDockerSwarmClient().get_node_inspect()

def test_AnsibleDockerSwarmClient_get_all_nodes_inspect():
    ret = AnsibleDockerSwarmClient().get_all_nodes_inspect()

def test_AnsibleDockerSwarmClient_get_all_nodes_list():
    ret = AnsibleDockerSwarmClient().get_all_nodes_list()

def test_AnsibleDockerSwarmClient_get_node_name_by_id():
    ret = AnsibleDockerSwarmClient().get_node_name_by_id()

def test_AnsibleDockerSwarmClient_get_unlock_key():
    ret = AnsibleDockerSwarmClient().get_unlock_key()

def test_AnsibleDockerSwarmClient_get_service_inspect():
    ret = AnsibleDockerSwarmClient().get_service_inspect()