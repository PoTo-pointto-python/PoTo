...
def test_Connection__buffered_exec_command():
    ret = Connection()._buffered_exec_command()

def test_Connection_exec_command():
    ret = Connection().exec_command()

def test_Connection__prefix_login_path():
    ret = Connection()._prefix_login_path()
