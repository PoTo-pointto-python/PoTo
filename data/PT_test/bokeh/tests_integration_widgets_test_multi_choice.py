...
from bokeh.models import Circle, ColumnDataSource, CustomAction, CustomJS, MultiChoice, Plot, Range1d
...
def Test_MultiChoice_test_displays_multi_choice(self, bokeh_model_page) -> None:
...
def Test_MultiChoice_test_displays_title(self, bokeh_model_page) -> None:
...
@flaky(max_runs=10)
def Test_MultiChoice_test_displays_menu(self, bokeh_model_page) -> None:
    text_input = MultiChoice(title='title', css_classes=['foo'], options=['100001', '12344556', '12344557', '3194567289', '209374209374'])
    page = bokeh_model_page(text_input)
...
@flaky(max_runs=10)
def Test_MultiChoice_test_server_on_change_round_trip_on_enter(self, bokeh_server_page) -> None:
