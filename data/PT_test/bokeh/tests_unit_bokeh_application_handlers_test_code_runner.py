...
def TestCodeRunner_test_init(self) -> None:
...
def TestCodeRunner_test_syntax_error_init(self) -> None:
...
def TestCodeRunner_test_package_error_init(self) -> None:
    with pytest.raises(ValueError):
        bahc.CodeRunner('This is a syntax error', '/foo/__init__.py', [], 'package')

def TestCodeRunner_test_new_module_success(self) -> None:
    cr = bahc.CodeRunner('# test', 'path', [])
    m = cr.new_module()
...
def TestCodeRunner_test_new_module_initpy(self) -> None:
...
def TestCodeRunner_test_new_module_package(self) -> None:
    cr = bahc.CodeRunner('# test', '/foo/__init__.py', [])
...
def TestCodeRunner_test_new_module_resets_run_errors(self) -> None:
    cr = bahc.CodeRunner('# test', 'path', [])
    cr._failed = True
    m = cr.new_module()
    assert isinstance(m, ModuleType)
...
def TestCodeRunner_test_new_module_returns_None_for_permanent_errors(self) -> None:
    cr = bahc.CodeRunner('This is a syntax error', 'path', [])
    assert cr.failed is True
    m = cr.new_module()
    assert m is None

def TestCodeRunner_test_reset_run_errors(self) -> None:
    cr = bahc.CodeRunner('# test', 'path', [])
    cr._failed = True
    cr._error = 'error'
...
def TestCodeRunner_test_reset_run_errors_leaves_permanent_errors(self) -> None:
    cr = bahc.CodeRunner('This is a syntax error', 'path', [])
    cr._failed = True
    cr.reset_run_errors()
    assert cr.failed is True
...
def TestCodeRunner_test_run_sets_ran(self) -> None:
    cr = bahc.CodeRunner('# test', 'path', [])
    m = cr.new_module()
    assert not cr.ran
...
def TestCodeRunner_test_run_runs_post_check(self) -> None:
    cr = bahc.CodeRunner('# test', 'path', [])
    m = cr.new_module()
    assert not cr.ran
    result = {}
...
def TestCodeRunner_test_run_fixups_argv(self) -> None:
...
def TestCodeRunner_test_run_fixups_path(self) -> None:
...
def TestCodeRunner_test_run_restores_cwd(self) -> None:
    old_cwd = os.getcwd()
...
def TestCodeRunner_test_run_restores_argv(self) -> None:
...
def TestCodeRunner_test_run_restores_path(self) -> None:
