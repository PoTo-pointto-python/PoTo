...
@flaky(max_runs=10)
def Test_RadioButtonGroup_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
...
def Test_RadioButtonGroup_test_js_on_change_executes(self, bokeh_model_page) -> None:
    group = RadioButtonGroup(labels=LABELS, css_classes=['foo'])
