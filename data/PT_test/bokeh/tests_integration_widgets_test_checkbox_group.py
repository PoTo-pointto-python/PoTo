...
def Test_CheckboxGroup_test_displays_options_list_of_string_labels_setting_inline(self, inline, bokeh_model_page) -> None:
    inline = True
...
@flaky(max_runs=10)
def Test_CheckboxGroup_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
...
def Test_CheckboxGroup_test_js_on_change_executes(self, bokeh_model_page) -> None:
    group = CheckboxGroup(labels=LABELS, css_classes=['foo'])
