...
def Test_Toggle_test_displays_label(self, bokeh_model_page) -> None:
...
def Test_Toggle_test_displays_button_type(self, typ, bokeh_model_page) -> None:
...
@flaky(max_runs=10)
def Test_Toggle_test_server_on_click_round_trip(self, bokeh_server_page) -> None:
...
def Test_Toggle_test_js_on_click_executes(self, bokeh_model_page) -> None:
    button = Toggle(css_classes=['foo'])
