...
def Test_TextInput_test_displays_text_input(self, bokeh_model_page) -> None:
    text_input = TextInput(css_classes=['foo'])
...
def Test_TextInput_test_displays_title(self, bokeh_model_page) -> None:
...
def Test_TextInput_test_displays_placeholder(self, bokeh_model_page) -> None:
...
@flaky(max_runs=10)
def Test_TextInput_test_server_on_change_no_round_trip_without_enter_or_click(self, bokeh_server_page) -> None:
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_TextInput_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
    page = bokeh_server_page(modify_doc)
    el = page.driver.find_element_by_css_selector('.foo input')
...
def Test_TextInput_test_js_on_change_executes(self, single_plot_page) -> None:
