...
def Test_AutocompleteInput_test_displays_text_input(self, bokeh_model_page) -> None:
...
def Test_AutocompleteInput_test_displays_title(self, bokeh_model_page) -> None:
...
def Test_AutocompleteInput_test_displays_menu(self, bokeh_model_page) -> None:
    text_input = AutocompleteInput(title='title', css_classes=['foo'], completions=['100001', '12344556', '12344557', '3194567289', '209374209374'])
    page = bokeh_model_page(text_input)
...
def Test_AutocompleteInput_test_min_characters(self, bokeh_model_page) -> None:
    text_input = AutocompleteInput(title='title', css_classes=['foo'], completions=['100001', '12344556', '12344557', '3194567289', '209374209374', 'aaaaaa', 'aaabbb', 'AAAaAA', 'AAABbB'], min_characters=1)
    page = bokeh_model_page(text_input)
    el = page.driver.find_element_by_css_selector('.foo .bk-menu')
    assert 'display: none;' in el.get_attribute('style')
    el = page.driver.find_element_by_css_selector('.foo input')
...
def Test_AutocompleteInput_test_case_insensitivity(self, bokeh_model_page) -> None:
...
def Test_AutocompleteInput_test_case_sensitivity(self, bokeh_model_page) -> None:
...
def Test_AutocompleteInput_test_arrow_cannot_escape_menu(self, bokeh_model_page) -> None:
    text_input = AutocompleteInput(title='title', css_classes=['foo'], completions=['100001', '12344556', '12344557', '3194567289', '209374209374'])
    page = bokeh_model_page(text_input)
    el = page.driver.find_element_by_css_selector('.foo .bk-menu')
    assert 'display: none;' in el.get_attribute('style')
...
def Test_AutocompleteInput_test_mouse_hover(self, bokeh_model_page) -> None:
    text_input = AutocompleteInput(title='title', css_classes=['foo'], completions=['100001', '12344556', '12344557', '3194567289', '209374209374'])
    page = bokeh_model_page(text_input)
    el = page.driver.find_element_by_css_selector('.foo .bk-menu')
    assert 'display: none;' in el.get_attribute('style')
...
@flaky(max_runs=10)
def Test_AutocompleteInput_test_server_on_change_no_round_trip_without_enter_or_click(self, bokeh_server_page) -> None:
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_AutocompleteInput_test_server_on_change_round_trip_full_entry(self, bokeh_server_page) -> None:
    page = bokeh_server_page(modify_doc)
    el = page.driver.find_element_by_css_selector('.foo input')
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_AutocompleteInput_test_server_on_change_round_trip_partial_entry(self, bokeh_server_page) -> None:
    page = bokeh_server_page(modify_doc)
    el = page.driver.find_element_by_css_selector('.foo input')
...
@flaky(max_runs=10)
def Test_AutocompleteInput_test_server_on_change_round_trip_menu_entry(self, bokeh_server_page) -> None:
    page = bokeh_server_page(modify_doc)
    el = page.driver.find_element_by_css_selector('.foo input')
    enter_text_in_element(page.driver, el, '123', click=2, enter=False)
