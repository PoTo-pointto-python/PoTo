...
def Test_Select_test_displays_title(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_options_list_of_string_options(self, bokeh_model_page) -> None:
    select = Select(options=['Option 1', 'Option 2', 'Option 3'], css_classes=['foo'])
    page = bokeh_model_page(select)
    el = page.driver.find_element_by_css_selector('.foo label')
    assert el.text == ''
...
def Test_Select_test_displays_options_list_of_string_options_with_default_value(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_list_of_tuple_options(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_list_of_tuple_options_with_default_value(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_options_dict_of_list_of_string_options(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_options_dict_of_list_of_string_options_with_default_value(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_dict_of_list_of_tuple_options(self, bokeh_model_page) -> None:
...
def Test_Select_test_displays_dict_of_list_of_tuple_options_with_default_value(self, bokeh_model_page) -> None:
...
@flaky(max_runs=10)
def Test_Select_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
...
def Test_Select_test_js_on_change_executes(self, bokeh_model_page) -> None:
    select = Select(options=['Option 1', 'Option 2', 'Option 3'], css_classes=['foo'])
