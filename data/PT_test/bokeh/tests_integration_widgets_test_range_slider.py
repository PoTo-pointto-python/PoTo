...
from bokeh._testing.util.selenium import RECORD, Keys, drag_range_slider, get_slider_bar_color, get_slider_title_text, get_slider_title_value, select_element_and_press_key
...
def Test_RangeSlider_test_display(self, bokeh_model_page) -> None:
...
def Test_RangeSlider_test_displays_title(self, bokeh_model_page) -> None:
...
def Test_RangeSlider_test_displays_title_scientific(self, bokeh_model_page) -> None:
    slider = RangeSlider(start=0, end=1e-05, step=1e-06, value=(1e-06, 8e-06), title='bar', format=BasicTickFormatter(precision=2), css_classes=['foo'], width=300)
    page = bokeh_model_page(slider)
    el = page.driver.find_element_by_css_selector('.foo')
    assert len(el.find_elements_by_css_selector('div.bk-input-group > div')) == 2
...
def Test_RangeSlider_test_title_updates(self, bokeh_model_page) -> None:
...
@pytest.mark.skip
def Test_RangeSlider_test_keypress_event(self, bokeh_model_page) -> None:
    slider = RangeSlider(start=0, end=10, value=(1, 5), title='bar', css_classes=['foo'], width=300)
    page = bokeh_model_page(slider)
    el = page.driver.find_element_by_css_selector('.foo')
...
def Test_RangeSlider_test_displays_bar_color(self, bokeh_model_page) -> None:
...
def Test_RangeSlider_test_js_on_change_executes(self, bokeh_model_page) -> None:
    slider = RangeSlider(start=0, end=10, value=(1, 5), title='bar', css_classes=['foo'], width=300)
...
@flaky(max_runs=10)
def Test_RangeSlider_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_RangeSlider_test_server_bar_color_updates(self, bokeh_server_page) -> None:
