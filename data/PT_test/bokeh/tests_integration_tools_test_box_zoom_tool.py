...
def Test_BoxZoomTool_test_deselected_by_default_with_pan_tool(self, single_plot_page) -> None:
...
def Test_BoxZoomTool_test_selected_by_default_without_pan_tool(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool())
    page = single_plot_page(plot)
    button = page.get_toolbar_button('box-zoom')
...
def Test_BoxZoomTool_test_can_be_selected_and_deselected(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool())
    plot.add_tools(PanTool())
    page = single_plot_page(plot)
    button = page.get_toolbar_button('box-zoom')
...
def Test_BoxZoomTool_test_box_zoom_has_no_effect_when_deslected(self, dim, single_plot_page) -> None:
    dim = 'both'
...
def Test_BoxZoomTool_test_box_zoom_with_corner_origin(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool())
    page = single_plot_page(plot)
...
def Test_BoxZoomTool_test_box_zoom_with_center_origin(self, single_plot_page) -> None:
...
def Test_BoxZoomTool_test_box_zoom_with_center_origin_clips_to_range(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool(origin='center'))
    page = single_plot_page(plot)
...
def Test_BoxZoomTool_test_box_zoom_width_updates_only_xrange(self, single_plot_page) -> None:
...
def Test_BoxZoomTool_test_box_zoom_width_clips_to_xrange(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool(dimensions='width'))
    page = single_plot_page(plot)
...
def Test_BoxZoomTool_test_box_zoom_height_updates_only_yrange(self, single_plot_page) -> None:
...
def Test_BoxZoomTool_test_box_zoom_height_clips_to_yrange(self, single_plot_page) -> None:
    plot = _make_plot(BoxZoomTool(dimensions='height'))
    page = single_plot_page(plot)
...
def Test_BoxZoomTool_test_box_zoom_can_match_aspect(self, single_plot_page) -> None:
