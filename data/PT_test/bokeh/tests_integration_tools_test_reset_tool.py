...
def Test_ResetTool_test_deselected_by_default(self, single_plot_page) -> None:
    plot = _make_plot()
...
def Test_ResetTool_test_clicking_resets_range(self, single_plot_page) -> None:
    plot = _make_plot()
    page = single_plot_page(plot)
...
def Test_ResetTool_test_clicking_resets_selection(self, single_plot_page) -> None:
    source = ColumnDataSource(dict(x=[1, 2], y=[1, 1]))
