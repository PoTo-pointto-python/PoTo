...
def Test_single_stack_test_raises_when_spec_in_kwargs(self) -> None:
    with pytest.raises(ValueError) as e:
        bps.single_stack(['a', 'b'], 'foo', foo=10)
    assert str(e.value).endswith("Stack property 'foo' cannot appear in keyword args")

def Test_single_stack_test_raises_when_kwargs_list_lengths_differ(self) -> None:
    with pytest.raises(ValueError) as e:
...
def Test_single_stack_test_raises_when_kwargs_list_lengths_and_stackers_lengths_differ(self) -> None:
    with pytest.raises(ValueError) as e:
...
def Test_single_stack_test_broadcast_with_no_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_single_stack_test_broadcast_with_scalar_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_single_stack_test_broadcast_with_list_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_single_stack_test_broadcast_name_scalar_overrides(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_single_stack_test_broadcast_name_list_overrides(self) -> None:
    names = ['aa', 'bb', 'cc', 'dd']
    stackers = ['a', 'b', 'c', 'd']
...
def Test_double_stack_test_raises_when_spec_in_kwargs(self) -> None:
    with pytest.raises(ValueError) as e:
...
def Test_double_stack_test_raises_when_kwargs_list_lengths_differ(self) -> None:
    with pytest.raises(ValueError) as e:
        bps.double_stack(['a', 'b'], 'foo', 'bar', baz=[1, 2], quux=[3, 4, 5])
    assert str(e.value).endswith('Keyword argument sequences for broadcasting must all be the same lengths. Got lengths: [2, 3]')

def Test_double_stack_test_raises_when_kwargs_list_lengths_and_stackers_lengths_differ(self) -> None:
    with pytest.raises(ValueError) as e:
        bps.double_stack(['a', 'b', 'c'], 'foo', 'bar', baz=[1, 2], quux=[3, 4])
    assert str(e.value).endswith('Keyword argument sequences for broadcasting must be the same length as stackers')

def Test_double_stack_test_broadcast_with_no_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_double_stack_test_broadcast_with_scalar_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_double_stack_test_broadcast_with_list_kwargs(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_double_stack_test_broadcast_name_scalar_overrides(self) -> None:
    stackers = ['a', 'b', 'c', 'd']
...
def Test_double_stack_test_broadcast_name_list_overrides(self) -> None:
    names = ['aa', 'bb', 'cc', 'dd']
    stackers = ['a', 'b', 'c', 'd']
