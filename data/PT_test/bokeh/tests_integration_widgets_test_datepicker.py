...
def Test_DatePicker_test_basic(self, bokeh_model_page) -> None:
...
def Test_DatePicker_test_inline(self, bokeh_model_page) -> None:
    dp = DatePicker(title='Select date', value=date(2019, 9, 20), min_date=date(2019, 9, 1), max_date='2019-09-30', inline=True, css_classes=['foo'])
    page = bokeh_model_page(dp)
    el = page.driver.find_element_by_css_selector('.foo label')
    assert el.text == 'Select date'
    el = page.driver.find_element_by_css_selector('.flatpickr-calendar')
...
def Test_DatePicker_test_widget_disabled(self, bokeh_model_page) -> None:
    dp = DatePicker(title='Select date', value=date(2019, 9, 20), min_date=date(2019, 9, 1), max_date='2019-09-30', disabled=True, css_classes=['foo'])
    page = bokeh_model_page(dp)
    el = page.driver.find_element_by_css_selector('.flatpickr-input')
    assert el.get_attribute('disabled') == 'true'
    assert page.has_no_console_errors()

def Test_DatePicker_test_disabled_dates(self, bokeh_model_page) -> None:
    dp = DatePicker(title='Select date', value=date(2019, 9, 20), min_date=date(2019, 9, 1), max_date='2019-09-30', disabled_dates=['2019-09-14', ('2019-09-16', date(2019, 9, 18))], css_classes=['foo'])
    page = bokeh_model_page(dp)
    el = page.driver.find_element_by_css_selector('.foo label')
    el.click()
...
def Test_DatePicker_test_enabled_dates(self, bokeh_model_page) -> None:
    dp = DatePicker(title='Select date', value=date(2019, 9, 20), min_date=date(2019, 9, 1), max_date='2019-09-30', enabled_dates=['2019-09-14', ('2019-09-16', date(2019, 9, 18))], css_classes=['foo'])
    page = bokeh_model_page(dp)
    el = page.driver.find_element_by_css_selector('.foo label')
    el.click()
    el = page.driver.find_element_by_css_selector('span[aria-label="September 13, 2019"]')
...
def Test_DatePicker_test_js_on_change_executes(self, bokeh_model_page) -> None:
    dp = DatePicker(title='Select date', value=date(2019, 9, 20), min_date=date(2019, 9, 1), max_date='2019-09-30', css_classes=['foo'])
...
@flaky(max_runs=10)
def Test_DatePicker_test_server_on_change_round_trip(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DatePicker_test_server_update_disabled(self, bokeh_server_page) -> None:
