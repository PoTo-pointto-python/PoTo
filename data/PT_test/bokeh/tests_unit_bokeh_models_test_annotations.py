...
import mock
from _util_models import ANGLE, FILL, LINE, TEXT, check_fill_properties, check_line_properties, check_properties_existence, check_text_properties, prefix
from bokeh.core.properties import field, value
from bokeh.core.validation import check_integrity
from bokeh.models import Arrow, ArrowHead, Band, BasicTicker, BasicTickFormatter, BoxAnnotation, ColorBar, ColumnDataSource, GlyphRenderer, Label, LabelSet, Legend, LegendItem, Slope, Span, Title, Whisker
...
def test_Arrow() -> None:
    ...
    check_properties_existence(arrow, ['level', 'visible', 'x_start', 'y_start', 'start_units', 'start', 'x_end', 'y_end', 'end_units', 'end', 'source', 'x_range_name', 'y_range_name'], LINE)
...
def test_BoxAnnotation() -> None:
    ...
    check_properties_existence(box, ['render_mode', 'visible', 'left', 'left_units', 'right', 'right_units', 'bottom', 'bottom_units', 'top', 'top_units', 'x_range_name', 'y_range_name', 'level'], LINE, FILL)
...
def test_Band() -> None:
    ...
    check_properties_existence(band, ['visible', 'level', 'lower', 'lower_units', 'upper', 'upper_units', 'base', 'base_units', 'dimension', 'source', 'x_range_name', 'y_range_name'], LINE, FILL)
...
def test_Label() -> None:
    ...
    check_properties_existence(label, ['level', 'visible', 'x', 'y', 'x_units', 'y_units', 'text', 'angle', 'angle_units', 'x_offset', 'y_offset', 'render_mode', 'x_range_name', 'y_range_name'], TEXT, prefix('border_', LINE), prefix('background_', FILL))
...
def test_LabelSet() -> None:
    ...
    check_properties_existence(label_set, ['visible', 'level', 'x', 'y', 'x_units', 'y_units', 'text', 'angle', 'angle_units', 'x_offset', 'y_offset', 'render_mode', 'x_range_name', 'y_range_name', 'source'], TEXT, ANGLE, prefix('border_', LINE), prefix('background_', FILL))
...
def test_Slope() -> None:
    ...
    check_properties_existence(slope, ['visible', 'gradient', 'y_intercept', 'x_range_name', 'y_range_name', 'level'], LINE)
...
def test_Span() -> None:
    ...
    check_properties_existence(line, ['visible', 'location', 'location_units', 'dimension', 'x_range_name', 'y_range_name', 'level', 'render_mode'], LINE)
...
def test_Title() -> None:
    ...
    check_properties_existence(title, ['visible', 'level', 'text', 'vertical_align', 'align', 'offset', 'text_font', 'text_font_size', 'text_font_style', 'text_color', 'text_alpha', 'text_line_height', 'x_range_name', 'y_range_name', 'render_mode'], prefix('border_', LINE), prefix('background_', FILL))
...
def test_Whisker() -> None:
    ...
    check_properties_existence(whisker, ['visible', 'level', 'lower', 'lower_units', 'lower_head', 'upper', 'upper_units', 'upper_head', 'base', 'base_units', 'dimension', 'source', 'x_range_name', 'y_range_name'], LINE)
