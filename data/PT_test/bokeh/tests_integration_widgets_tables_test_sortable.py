...
def Test_DataTableSortable_test_columns_sortable(self, bokeh_model_page) -> None:
...
def Test_DataTableSortable_test_click_nonsortable(self, bokeh_model_page) -> None:
    data = {'x': [1, 2, 3, 4], 'y': [4, 3, 2, 1], 'd': ['foo', 'bar', 'baz', 'quux']}
    source = ColumnDataSource(data)
    table = DataTable(columns=[TableColumn(field='x', title='x'), TableColumn(field='y', title='y', sortable=False), TableColumn(field='d', title='d', sortable=True)], source=source)
    page = bokeh_model_page(table)
...
def Test_DataTableSortable_test_click_sortable(self, bokeh_model_page) -> None:
    data = {'x': [1, 2, 3, 4], 'y': [4, 3, 2, 1], 'd': ['foo', 'bar', 'baz', 'quux']}
    source = ColumnDataSource(data)
    table = DataTable(columns=[TableColumn(field='x', title='x'), TableColumn(field='y', title='y', sortable=False), TableColumn(field='d', title='d', sortable=True)], source=source)
    page = bokeh_model_page(table)
...
def Test_DataTableSortable_test_table_unsortable(self, bokeh_model_page) -> None:
    data = {'x': [1, 2, 3, 4], 'y': [4, 3, 2, 1], 'd': ['foo', 'bar', 'baz', 'quux']}
    source = ColumnDataSource(data)
