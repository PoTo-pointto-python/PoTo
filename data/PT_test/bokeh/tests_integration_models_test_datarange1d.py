...
def Test_DataRange1d_test_includes_hidden_glyphs_by_default(self, single_plot_page) -> None:
...
def Test_DataRange1d_test_includes_hidden_glyphs_when_asked(self, single_plot_page) -> None:
...
def Test_DataRange1d_test_excludes_hidden_glyphs_when_asked(self, single_plot_page) -> None:
...
def Test_DataRange1d_test_updates_when_visibility_is_toggled(self, single_plot_page) -> None:
    source = ColumnDataSource(dict(x=[1, 2], y1=[0, 1], y2=[10, 11]))
