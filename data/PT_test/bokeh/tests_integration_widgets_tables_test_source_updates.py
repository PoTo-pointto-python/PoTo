...
from bokeh._testing.util.selenium import RECORD, alt_click, enter_text_in_cell, get_table_cell, get_table_column_cells, get_table_row, get_table_selected_rows, shift_click, sort_table_column
from bokeh.layouts import column
from bokeh.models import Button, ColumnDataSource, CustomAction, CustomJS, DataTable, NumberEditor, Plot, Range1d, Rect, TableColumn, TapTool
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_source_patch_does_not_duplicate_data_update_event(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_source_stream_does_not_duplicate_data_update_event(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_source_update_does_not_duplicate_data_update_event(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_edit_does_not_duplicate_data_update_event(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_basic_selection(self, bokeh_server_page) -> None:
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_basic_mulitselection(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 3, 4, 5, 6], 'y': [60, 50, 40, 30, 20, 10]}
    source = ColumnDataSource(data)
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_sorted_after_data_update(self, bokeh_server_page) -> None:
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_DataTableSource_test_server_sorted_after_patch(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 5, 6], 'y': [60, 50, 20, 10]}
    source = ColumnDataSource(data)
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_DataTableSource_test_server_sorted_after_stream(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 5, 6], 'y': [60, 50, 20, 10]}
    source = ColumnDataSource(data)
...
@pytest.mark.skip
@flaky(max_runs=10)
def Test_DataTableSource_test_server_sorted_after_edit(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 5, 6], 'y': [60, 50, 20, 10]}
    source = ColumnDataSource(data)
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_source_updated_after_edit(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 5, 6], 'y': [60, 50, 20, 10]}
    source = ColumnDataSource(data)
...
@flaky(max_runs=10)
def Test_DataTableSource_test_server_source_callback_triggered_after_edit(self, bokeh_server_page) -> None:
    data = {'x': [1, 2, 5, 6], 'y': [60, 50, 20, 10]}
    source = ColumnDataSource(data)
    result = []
...
def Test_DataTableSource_test_glyph_selection_updates_table(self, single_plot_page) -> None:
