...
def Test_get_graph_kwargs_test_convert_dataframes_to_sources(self, pd) -> None:
...
def Test_get_graph_kwargs_test_handle_sources(self) -> None:
...
def Test_get_graph_kwargs_test_handle_node_property_mixins(self) -> None:
...
def Test_get_graph_kwargs_test_handle_node_marker(self) -> None:
    kw = bpg.get_graph_kwargs({}, {}, node_marker='x')
    node_glyph = kw['node_renderer'].glyph
    assert isinstance(node_glyph, X)

def Test_get_graph_kwargs_test_handle_node_marker_dataspec_correctly(self) -> None:
...
def Test_get_graph_kwargs_test_handle_edge_property_mixins(self) -> None:
