import pytest
pytest
from _util_models import FILL, GLYPH, HATCH, LINE, MARKER, TEXT, check_fill_properties, check_hatch_properties, check_line_properties, check_marker_properties, check_properties_existence, check_text_properties
from bokeh.core.enums import Anchor, AngleUnits, ButtonType, DashPattern, Dimension, Direction, FontStyle, LegendLocation, LineCap, LineDash, LineJoin, Location, MapType
...
from bokeh.models.glyphs import Asterisk, CircleCross, CircleX, Cross, Dash, Diamond, DiamondCross, InvertedTriangle, Square, SquareCross, SquareX, Triangle, X
from bokeh.models.glyphs import AnnularWedge, Annulus, Arc, Bezier, Circle, HArea, HBar, Image, ImageRGBA, ImageURL, Line, MultiLine, MultiPolygons, Oval, Patch, Patches, Quad, Quadratic, Ray, Rect, Segment, Step, Text, VArea, VBar, Wedge
...
def test_AnnularWedge() -> None:
    ...
    check_properties_existence(glyph, ['x', 'y', 'inner_radius', 'inner_radius_units', 'outer_radius', 'outer_radius_units', 'start_angle', 'start_angle_units', 'end_angle', 'end_angle_units', 'direction'], FILL, LINE, GLYPH)
...
def test_Annulus() -> None:
    ...
    check_fill_properties(glyph)
    check_line_properties(glyph)
    check_properties_existence(glyph, ['x', 'y', 'inner_radius', 'inner_radius_units', 'outer_radius', 'outer_radius_units'], FILL, LINE, GLYPH)
...
def test_Image() -> None:
    ...
    check_properties_existence(glyph, ['image', 'x', 'y', 'dw', 'dw_units', 'dh', 'dh_units', 'global_alpha', 'dilate', 'color_mapper'], GLYPH)
...
def test_ImageRGBA() -> None:
    ...
    assert glyph.dh is None
    assert glyph.dilate is False
    check_properties_existence(glyph, ['image', 'x', 'y', 'dw', 'dw_units', 'dh', 'dh_units', 'global_alpha', 'dilate'], GLYPH)
...
def test_Oval() -> None:
    ...
    check_fill_properties(glyph)
    check_line_properties(glyph)
    check_properties_existence(glyph, ['x', 'y', 'width', 'width_units', 'height', 'height_units', 'angle', 'angle_units'], FILL, LINE, GLYPH)
...
def test_Rect() -> None:
    ...
    check_fill_properties(glyph)
    check_line_properties(glyph)
    check_properties_existence(glyph, ['x', 'y', 'width', 'width_units', 'height', 'height_units', 'angle', 'angle_units', 'dilate'], FILL, LINE, GLYPH)
...
def test_Wedge() -> None:
    ...
    check_fill_properties(glyph)
    check_line_properties(glyph)
    check_properties_existence(glyph, ['x', 'y', 'radius', 'radius_units', 'start_angle', 'start_angle_units', 'end_angle', 'end_angle_units', 'direction'], FILL, LINE, GLYPH)
