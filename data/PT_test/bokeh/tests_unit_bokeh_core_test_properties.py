...
ALL = ('Angle', 'AngleSpec', 'Any', 'AnyRef', 'Array', 'Auto', 'Base64String', 'Bool', 'Byte', 'Color', 'ColorHex', 'ColorSpec', 'ColumnData', 'Complex', 'DashPattern', 'DataDistanceSpec', 'DataSpec', 'Date', 'Datetime', 'Dict', 'DistanceSpec', 'Either', 'Enum', 'Float', 'FontSize', 'FontSizeSpec', 'HatchPatternSpec', 'HatchPatternType', 'Image', 'Include', 'Instance', 'Int', 'Interval', 'JSON', 'List', 'MarkerSpec', 'MarkerType', 'MinMaxBounds', 'NonNegativeInt', 'NumberSpec', 'Override', 'PandasDataFrame', 'PandasGroupBy', 'Percent', 'PositiveInt', 'PropertyUnitsSpec', 'RGB', 'Regex', 'RelativeDelta', 'ScreenDistanceSpec', 'Seq', 'Size', 'String', 'StringSpec', 'Struct', 'TimeDelta', 'Tuple', 'UnitsSpec', 'expr', 'field', 'validate', 'value', 'without_property_validation')
...
def Basictest_test_simple_class(self) -> None:
...
def Basictest_test_enum(self) -> None:
...
def Basictest_test_inheritance(self) -> None:
...
def Basictest_test_set(self) -> None:
...
def Basictest_test_no_parens(self) -> None:
...
def Basictest_test_accurate_properties_sets(self) -> None:
    ...
    assert s.properties(with_bases=True) == {'num', 'container', 'child', 'mixin_num', 'mixin_container', 'mixin_child', 'sub_num', 'sub_container', 'sub_child'}
...
def Basictest_test_accurate_dataspecs(self) -> None:
...
def Basictest_test_not_serialized(self) -> None:
...
def Basictest_test_readonly(self) -> None:

    class Readonly(HasProps):
        x = Int(12, readonly=True)
        y = Int(readonly=True)
        z = String('hello')
    o = Readonly()
    assert o.x == 12
...
def Basictest_test_include_defaults(self) -> None:
...
def Basictest_test_include_defaults_with_kwargs(self) -> None:
...
def Basictest_test_include_defaults_set_to_same(self) -> None:
...
def Basictest_test_override_defaults(self) -> None:
